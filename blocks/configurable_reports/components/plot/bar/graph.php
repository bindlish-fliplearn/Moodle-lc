...
if (!$reportclass->check_permissions($USER->id, $context)) {
    ...
    if (!empty($graphs)) {
        ...
        if ($g['id'] == $id) {
            include($CFG->dirroot."/blocks/configurable_reports/lib/pChart3/class/pDraw.class.php");
            include($CFG->dirroot."/blocks/configurable_reports/lib/pChart3/class/pData.class.php");
            include($CFG->dirroot."/blocks/configurable_reports/lib/pChart3/class/pImage.class.php");
            ...
            $padding = 30;
            $fontsize = 8;
            $fontpath = $CFG->dirroot."/blocks/configurable_reports/lib/pChart3/fonts";
