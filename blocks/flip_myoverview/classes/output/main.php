 ...
 */
namespace block_flip_myoverview\output;
...
class main implements renderable, templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $nocoursesurl = $output->image_url('courses', 'block_flip_myoverview')->out();
        $noeventsurl = $output->image_url('activities', 'block_flip_myoverview')->out();

        // Now, set the tab we are going to be viewing.
        $viewingtimeline = false;
        $viewingcourses = false;
        if ($this->tab == BLOCK_FLIP_MYOVERVIEW_TIMELINE_VIEW) {
