@block @block_flip_myoverview @javascript
Feature: Course overview block show users their progress on courses
  ...
  Scenario: Course progress percentage should not be displayed if completion is not enabled
    ...
    Then I should see "Test choice 1 closes" in the "#flip_myoverview_timeline_courses" "css_element"
  ...
  Scenario: User complete activity and verify his progress
    ...
    And I should see "Test choice 1 closes" in the "#flip_myoverview_timeline_courses" "css_element"
