 ...
 *
 * @module     block_flip_myoverview/calendar_events_repository
 * @class      repository
...
define(['jquery', 'core/ajax', 'core/notification'], function($, Ajax, Notification) {
    ...
    var queryByTime = function(args) {
      ...
      var queryByCompletedEvent = function(args) {
        if (!args.hasOwnProperty('limit')) {
            args.limit = DEFAULT_LIMIT;
        }
        ...
        // };
        var request = {
            methodname: 'local_calendar_get_action_completed_events_by_timesort',
            args: args
        };
    ...
    return {
        ...
        queryByCompletedEvent:queryByCompletedEvent,
    };
});
