 ...
 *
 * @module    mod_hwork/random_question_form_preview
 * @package   mod_hwork
...
define(
    ...
    var TEMPLATE_NAME = 'mod_hwork/random_question_form_preview_question_list';
    var SELECTORS = {
    ...
    var renderQuestionCount = function(root, questionCount) {
        Str.get_string('questionsmatchingfilter', 'mod_hwork', questionCount)
