 ...
 *
 * This is also responsible for opening the pop-up window, if the hwork requires to be in one.
 *
 * @module    mod_hwork/preflightcheck
...
define(['jquery', 'core/yui'], function($, Y) {
    ...
    /**
     * @alias module:mod_hwork/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the hwork should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_hwork_preflight_popup']
                    });
        ...
        /**
         * Event handler for the hwork start attempt button.
