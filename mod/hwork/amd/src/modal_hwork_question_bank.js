 ...
 *
 * @module     mod_hwork/modal_hwork_question_bank
 * @package    mod_hwork
...
function(
    ...
    var SELECTORS = {
        ADD_TO_QUIZ_CONTAINER: 'td.addtohworkaction',
        ANCHOR: 'a[href]',
    ...
    ModalQuizQuestionBank.TYPE = 'mod_hwork-hwork-question-bank';
     ...
     * when the user clicks the add to hwork link.
     *
    ...
    ModalQuizQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to hwork link.
