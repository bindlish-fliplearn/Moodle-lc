...
/**
 * Strings for component 'hwork', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_hwork
...
$string['addquestionstohwork'] = 'Add questions to current Homework';
...
$string['addrandomquestiontohwork'] = 'Add a random question to Homework {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstohwork'] = 'Add selected questions to the Homework';
$string['addselectedtohwork'] = 'Add selected to Homework';
$string['addtohwork'] = 'Add to Homework';
...
$string['attempthworknow'] = 'Attempt Homework now';
...
$string['backtohwork'] = 'Back to Homework editing';
$string['basicideasofhwork'] = 'The basic ideas of Homework-making';
...
$string['continueattempthwork'] = 'Continue the last attempt';
...
$string['editinghwork'] = 'Editing Homework';
$string['editinghwork_help'] = 'When creating a Homework, the main concepts are:
...
$string['editinghwork_link'] = 'mod/hwork/edit';
$string['editinghworkx'] = 'Editing Homework: {$a}';
...
You can access this Homework at {$a->hworkurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->hworkname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->hworkname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->hworkname}\' ({$a->hworkurl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->hworkreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->hworkname}. See {$a->hworkreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->hworkname}';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->hworkname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->hworkname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->hworkname}';
$string['empty'] = 'Empty';
...
$string['eventhworkattemptabandoned'] = ' Homework attempt abandoned';
$string['eventhworkattempttimelimitexceeded'] = ' Homework attempt time limit exceeded';
$string['eventhworkattemptstarted'] = ' Homework attempt started';
$string['eventhworkattemptsubmitted'] = ' Homework attempt submitted';
...
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->hworkgrade}.';
...
$string['invalidhworkid'] = 'Invalid Homework ID';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->hwork} by {$a->user}';
$string['mark'] = 'Submit';
...
* For self-assessment';
$string['modulename_link'] = 'mod/hwork/view';
...
$string['noquestionsinhwork'] = 'There are no questions in this Homework.';
...
$string['orderinghwork'] = 'Order and paging';
$string['orderinghworkx'] = 'Order and paging: {$a}';
...
$string['overduehandling_link'] = 'mod/hwork/timing';
...
$string['overridegroupeventname'] = '{$a->hwork} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->hwork} - Override';
$string['pageshort'] = 'P';
...
$string['page-mod-hwork-view'] = ' Homework information page';
...
$string['previewhwork'] = 'Preview {$a}';
$string['previewhworknow'] = 'Preview Homework now';
...
$string['privacy:metadata:hwork'] = 'The Homework activity makes use of Homework reports.';
$string['privacy:metadata:hwork_attempts'] = 'Details about each attempt on a Homework.';
$string['privacy:metadata:hwork_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:hwork_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:hwork_attempts:preview'] = 'Whether this is a preview of the Homework.';
$string['privacy:metadata:hwork_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:hwork_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:hwork_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:hwork_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:hwork_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:hwork_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:hwork_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:hwork_grades'] = 'Details about the overall grade for this Homework.';
$string['privacy:metadata:hwork_grades:grade'] = 'The overall grade for this Homework.';
$string['privacy:metadata:hwork_grades:hwork'] = 'The Homework that was graded.';
$string['privacy:metadata:hwork_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:hwork_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:hwork_overrides'] = 'Details about overrides for this Homework';
$string['privacy:metadata:hwork_overrides:hwork'] = 'The Homework with override information';
$string['privacy:metadata:hwork_overrides:timeclose'] = 'The new close time for the Homework.';
$string['privacy:metadata:hwork_overrides:timelimit'] = 'The new time limit for the Homework.';
$string['privacy:metadata:hwork_overrides:timeopen'] = 'The new open time for the Homework.';
$string['privacy:metadata:hwork_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:hworkaccess'] = 'The Homework activity makes use of Homework access rules.';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->hworknames}<br />The question will not be deleted from these Homeworkzes but only from the category list.';
...
$string['questionsinthishwork'] = 'Questions in this Homework';
...
$string['hwork:addinstance'] = 'Add a new Homework';
$string['hwork:attempt'] = 'Attempt Homeworkzes';
$string['hworkavailable'] = 'The Homework is available until: {$a}';
$string['hworkclose'] = 'Close the Homework';
$string['hworkclosed'] = 'This Homework closed on {$a}';
$string['hworkcloses'] = ' Homework closes';
$string['hworkeventcloses'] = '{$a} closes';
$string['hworkcloseson'] = 'This Homework will close at {$a}';
$string['hwork:deleteattempts'] = 'Delete Homework attempts';
$string['hwork:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['hwork:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['hwork:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['hwork:grade'] = 'Grade Homeworkzes manually';
$string['hwork:ignoretimelimits'] = 'Ignores time limit on Homeworkzes';
$string['hworkisclosed'] = 'This Homework is closed';
$string['hworkisopen'] = 'This Homework is open';
$string['hworkisclosedwillopen'] = ' Homework closed (opens {$a})';
$string['hworkisopenwillclose'] = ' Homework open (closes {$a})';
$string['hwork:manage'] = 'Manage Homeworkzes';
$string['hwork:manageoverrides'] = 'Manage Homework overrides';
$string['hworknavigation'] = ' Homework navigation';
$string['hworkopen'] = 'Open the Homework';
$string['hworkeventopens'] = '{$a} opens';
$string['hworkopenclose'] = 'Open and close dates';
$string['hworkopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['hworkopenclose_link'] = 'mod/hwork/timing';
$string['hworkopened'] = 'This Homework is open.';
$string['hworkopenedon'] = 'This Homework opened at {$a}';
$string['hworkopens'] = ' Homework opens';
$string['hworkopenwillclose'] = 'This Homework is open, will close on {$a} at';
$string['hworkordernotrandom'] = 'Order of Homework not shuffled';
$string['hworkorderrandom'] = '* Order of Homework is shuffled';
$string['hwork:preview'] = 'Preview Homeworkzes';
$string['hwork:regrade'] = 'Regrade Homework attempts';
$string['hwork:reviewmyattempts'] = 'Review your own attempts';
$string['hworksettings'] = ' Homework settings';
$string['hwork:view'] = 'View Homework information';
$string['hwork:viewreports'] = 'View Homework reports';
$string['hworktimer'] = ' Homework Timer';
$string['hworkwillopen'] = 'This Homework will open {$a}';
...
$string['reattempthwork'] = 'Re-attempt Homework';
...
$string['regradinghwork'] = 'Regrading Homework "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallhworkattempts'] = 'Delete all Homework attempts';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->hwork} by {$a->user}';
...
$string['savehwork'] = 'Save this whole Homework';
...
$string['specificquestionnotonhwork'] = 'Specified question is not on the specified Homework';
...
$string['subplugintype_hwork'] = 'Report';
$string['subplugintype_hwork_plural'] = 'Reports';
$string['subplugintype_hworkaccess'] = 'Access rule';
$string['subplugintype_hworkaccess_plural'] = 'Access rules';
...
$string['timelimit_link'] = 'mod/hwork/timing';
...
$string['updatehworkslotswithrandomxofy'] = 'Updating Homework slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradinghworkattempts'] = 'Upgrading Homework attempts: Homework {$a->done}/{$a->outof} ( Homework id {$a->info})';
$string['upgradingveryoldhworkattempts'] = 'Upgrading very old Homework attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
