...
/**
 * Class to store the options for a {@link hwork_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class hwork_overview_options extends mod_hwork_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('hwork_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (hwork_has_grades($this->hwork)) {
            set_user_preference('hwork_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/hwork:regrade', 'mod/hwork:deleteattempts'), context_module::instance($this->cm->id))
