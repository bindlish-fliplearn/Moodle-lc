...
/**
 * This page prints a summary of a hwork attempt before it is submitted.
 *
 * @package   mod_hwork
...
$PAGE->set_url('/mod/hwork/summary.php', array('attempt' => $attemptid));
...
$navbc = $attemptobj->get_navigation_panel($output, 'hwork_attempt_nav_panel', -1);
$regions = $PAGE->blocks->get_regions();
$PAGE->blocks->add_fake_block($navbc, reset($regions));

$PAGE->navbar->add(get_string('summaryofattempt', 'hwork'));
