...
/**
 * This page deals with processing responses during an attempt at a hwork.
 *
...
if ($attemptobj->is_finished()) {
    throw new moodle_hwork_exception($attemptobj->get_hworkobj(),
...
if ($status == hwork_attempt::OVERDUE) {
    redirect($attemptobj->summary_url());
} else if ($status == hwork_attempt::IN_PROGRESS) {
    redirect($nexturl);
} else {
