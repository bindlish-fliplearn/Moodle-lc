 ...
 *
 * @module     mod_pratest/modal_pratest_question_bank
 * @package    mod_pratest
...
function(
    ...
    var SELECTORS = {
        ADD_TO_QUIZ_CONTAINER: 'td.addtopratestaction',
        ANCHOR: 'a[href]',
    ...
    ModalQuizQuestionBank.TYPE = 'mod_pratest-pratest-question-bank';
     ...
     * when the user clicks the add to pratest link.
     *
     ...
     *      - The pratest category select box
    ...
    ModalQuizQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to pratest link.
