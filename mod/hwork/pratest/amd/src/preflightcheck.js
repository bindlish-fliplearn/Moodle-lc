 ...
 *
 * This is also responsible for opening the pop-up window, if the pratest requires to be in one.
 *
 * @module    mod_pratest/preflightcheck
...
define(['jquery', 'core/yui'], function($, Y) {
    ...
    /**
     * @alias module:mod_pratest/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the pratest should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_pratest_preflight_popup']
                    });
        ...
        /**
         * Event handler for the pratest start attempt button.
