@mod @mod_pratest
Feature: Edit pratest page - adding things
  In order to build the pratest I want my students to attempt
  As a teacher
  I need to be able to add questions to the pratest.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | pratest       | Quiz 1 | Quiz 1 for testing the Add menu | C1     | pratest1    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Quiz 1"
    And I navigate to "Edit pratest" in current page administration
    Then I should see "Editing pratest: Quiz 1"

  @javascript
  Scenario: Add some new question to the pratest using '+ a new question' options of the 'Add' menu.
    And I open the "last" add to pratest menu
    ...
    Then I should see "Editing pratest: Quiz 1"
    And I should see "Essay 01 new" on pratest page "1"

    And I open the "Page 1" add to pratest menu
    And I follow "a new question"
    And I set the field "item_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    Then I should see "Editing pratest: Quiz 1"
    And I should see "Essay 01 new" on pratest page "1"
    And I should see "Essay 02 new" on pratest page "1"
    ...
    And I should see "Essay 01 new" on pratest page "1"
    And I should see "Essay 02 new" on pratest page "1"
    And I should see "Essay 03 new" on pratest page "1"
    ...
    And I should see "Essay 02 new" on pratest page "1"
    And I should see "Essay 03 new" on pratest page "1"
    And I should see "Essay 04 new" on pratest page "1"
    ...
    And I should see "Essay 01 new" on pratest page "1"
    And I should see "Essay 02 new" on pratest page "1"
    And I should see "Essay 03 new" on pratest page "2"
    And I should see "Essay 04 new" on pratest page "2"
    ...
    And I should see "Essay 03 new" on pratest page "2"
    And I should see "Essay 04 new" on pratest page "2"
    And I should see "Essay for page 2" on pratest page "2"

  @javascript
  Scenario: Add questions from question bank to the pratest. In order to be able to
      add questions from question bank to the pratest, first we create some new questions
    ...
    Then the "Add selected questions to the pratest" "button" should be disabled
    And I click on "Essay 03" "checkbox"
    Then the "Add selected questions to the pratest" "button" should be enabled
    And I click on "Add to pratest" "link" in the "Essay 03" "table_row"
    Then I should see "Editing pratest: Quiz 1"
    And I should see "Essay 03" on pratest page "1"

    # Add Essay 01 from question bank.
    And I open the "Page 1" add to pratest menu
    And I follow "from question bank"
    And I click on "Add to pratest" "link" in the "Essay 01" "table_row"
    Then I should see "Editing pratest: Quiz 1"
    And I should see "Essay 03" on pratest page "1"
    And I should see "Essay 01" on pratest page "1"
    ...
    And I should see "Select a category"
    And I set the field "Select a category" to "Subcat 1"
    And I click on "Add to pratest" "link" in the "Essay 02" "table_row"
    Then I should see "Editing pratest: Quiz 1"
    And I should see "Essay 03" on pratest page "1"
    And I should see "Essay 01" on pratest page "1"
    And I should see "Essay 02" on pratest page "1"
    ...
    And I should see "Essay 01" on pratest page "1"
    And I should see "Essay 02" on pratest page "1"
    And I should see "Random" on pratest page "1"
    ...
    When I press "Go"
    And I should see "Essay 03" on pratest page "1"
    And I should see "Essay 01" on pratest page "2"
    And I should see "Essay 02" on pratest page "3"
    And I should see "Random" on pratest page "4"

    # Add a random question to page 4.
    And I open the "Page 4" add to pratest menu
    And I choose "a new question" in the open action menu
    And I set the field "item_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    And I should see "Essay 02" on pratest page "3"
    And I should see "Random" on pratest page "4"
    And I should see "Essay for page 4" on pratest page "4"
