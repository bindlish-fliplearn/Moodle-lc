@mod @mod_pratest
Feature: Edit pratest page - remove questions
  ...
  Scenario: Delete questions by clicking on the delete icon.
    ...
    When I delete "Question C" in the pratest by clicking the delete icon
    Then I should see "Question A" on pratest page "1"
    And I should see "Question B" on pratest page "1"
    ...
    Then I should see "Question B" on pratest page "2"
    And the "Remove" page break icon after question "Question A" should exist
    And I delete "Question A" in the pratest by clicking the delete icon
    Then I should see "Question B" on pratest page "1"
    And I should not see "Page 2"
    And I should not see "Question A" on pratest page "2"
