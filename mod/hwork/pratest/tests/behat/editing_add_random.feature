@mod @mod_pratest @javascript
Feature: Adding random questions to a pratest based on category and tags
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | pratest       | Quiz 1 | Quiz 1 for testing the Add random question form | C1     | pratest1    |
