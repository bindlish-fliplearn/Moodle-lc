...
/**
 * Strings for component 'pratest', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_pratest
...
$string['accessnoticesheader'] = 'You can preview this pratest, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have pratestzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the pratest. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the pratest. This means that different students are likely to get a different selection of questions, and when a pratest allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any pratest in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your pratest over on the other side of this page.</p>';
...
$string['addquestionstopratest'] = 'Add questions to current pratest';
...
$string['addrandomquestiontopratest'] = 'Add a random question to pratest {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstopratest'] = 'Add selected questions to the pratest';
$string['addselectedtopratest'] = 'Add selected to pratest';
$string['addtopratest'] = 'Add to pratest';
...
$string['attempterror'] = 'You are not allowed to attempt this pratest at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid pratest attempt ID';
$string['attempterrorcontentchange'] = 'This pratest preview no longer exists. (When a pratest is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This pratest attempt no longer exists.';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptpratestnow'] = 'Attempt pratest now';
$string['attempts'] = 'Attempts';
$string['attempts_help'] = 'The total number of attempts allowed (not the number of extra attempts).';
$string['attemptsallowed'] = 'Attempts allowed';
$string['attemptsdeleted'] = 'Practice Test attempts deleted';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during pratest attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtopratest'] = 'Back to pratest editing';
$string['basicideasofpratest'] = 'The basic ideas of pratest-making';
...
* The pratest will only start if the student has a JavaScript-enabled web-browser
* The pratest appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this pratest has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the pratest';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this pratest. The pratest is set to be graded out of {$a->grade}, but none of the questions in the pratest have a grade. This can be fixed on the \'Edit pratest\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this pratest. The pratest definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this pratest. The pratest has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire pratest attempt and start another one. This option is mainly useful for practice pratestzes.
...
$string['canredoquestions_help'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire pratest attempt and start another one. This option is mainly useful for practice pratestzes.
...
$string['closebeforeopen'] = 'Could not update the pratest. You have specified a close date before the open date.';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the pratest settings) or higher.';
...
$string['completionattemptsexhausted_help'] = 'Mark pratest complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the pratest.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the pratest.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the pratest.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a pratest after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the pratest.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new pratest. You can also configure which pratest settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the pratest grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the pratest page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the pratest editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during pratest attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the pratest.';
$string['configrequiresubnet'] = 'Students can only attempt the pratest from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a pratest attempt or look at the pratest reports.';
$string['configshowblocks'] = 'Show blocks during pratest attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this pratest, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for pratestzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for pratestzes in seconds. 0 mean no time limit.';
...
$string['continueattemptpratest'] = 'Continue the last attempt';
...
$string['countdownfinished'] = 'The pratest is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The pratest will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to pratest';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the pratest.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the pratest a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the pratest a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/pratest folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new pratest attempt will contain the results of the previous attempt. This allows a pratest to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingpratest'] = 'Editing pratest';
$string['editingpratest_help'] = 'When creating a pratest, the main concepts are:

* The pratest, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the pratest and different students can get different questions';
$string['editingpratest_link'] = 'mod/pratest/edit';
$string['editingpratestx'] = 'Editing pratest: {$a}';
...
$string['editpratest'] = 'Edit pratest';
$string['editpratestquestions'] = 'Edit pratest questions';
$string['emailconfirmbody'] = 'Hi {$a->username},

Thank you for submitting your answers to \'{$a->pratestname}\' in course \'{$a->coursename}\' at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this pratest at {$a->pratesturl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->pratestname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->pratestname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->pratestname}\' ({$a->pratesturl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->pratestreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->pratestname}. See {$a->pratestreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->pratestname}';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->pratestname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->pratestname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->pratestname}';
$string['empty'] = 'Empty';
...
$string['eventattemptdeleted'] = 'Practice Test attempt deleted';
$string['eventattemptpreviewstarted'] = 'Practice Test attempt preview started';
$string['eventattemptreviewed'] = 'Practice Test attempt reviewed';
$string['eventattemptsummaryviewed'] = 'Practice Test attempt summary viewed';
$string['eventattemptviewed'] = 'Practice Test attempt viewed';
$string['eventeditpageviewed'] = 'Practice Test edit page viewed';
$string['eventoverridecreated'] = 'Practice Test override created';
$string['eventoverridedeleted'] = 'Practice Test override deleted';
$string['eventoverrideupdated'] = 'Practice Test override updated';
$string['eventquestionmanuallygraded'] = 'Question manually graded';
$string['eventpratestattemptabandoned'] = 'Practice Test attempt abandoned';
$string['eventpratestattempttimelimitexceeded'] = 'Practice Test attempt time limit exceeded';
$string['eventpratestattemptstarted'] = 'Practice Test attempt started';
$string['eventpratestattemptsubmitted'] = 'Practice Test attempt submitted';
$string['eventreportviewed'] = 'Practice Test report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the pratest. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the pratest when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the pratest. You have to make a trade-off based on how much you trust the performance of your server during pratestzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final pratest grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'Practice Test grades deleted';
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->pratestgrade}.';
$string['gradetopassnotset'] = 'This pratest does not yet have a grade to pass set. It may be set in the Grade section of the pratest settings.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this pratest has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt pratestzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a pratest.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the pratest';
$string['incorrect'] = 'Incorrect';
$string['indicator:cognitivedepth'] = 'Practice Test cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a Practice Test activity.';
$string['indicator:socialbreadth'] = 'Practice Test social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a Practice Test activity.';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new pratest, provide this many blank overall feedback boxes. Once the pratest has been created, the form shows the number of fields required for the number of feedbacks in the pratest. The setting must be at least 1.';
...
$string['invalidpratestid'] = 'Invalid pratest ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in pratest';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->pratest} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your pratest attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own pratest submissions';
$string['messageprovider:submission'] = 'Notification of pratest submissions';
$string['max'] = 'Max';
...
$string['modulename_help'] = 'The pratest activity enables a teacher to create pratestzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the pratest to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/pratest/view';
$string['modulenameplural'] = 'Practice Testzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the pratest in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the pratest';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer pratestzes it makes sense to stretch the pratest over several pages by limiting the number of questions per page. When adding questions to the pratest, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this pratest';
...
$string['nogradewarning'] = 'This pratest is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the pratest settings.';
...
$string['noquestionsinpratest'] = 'There are no questions in this pratest.';
...
$string['noreview'] = 'You are not allowed to review this pratest';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this pratest until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This pratest is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the pratest module. As a work around, set a time limit for the whole pratest. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this pratest';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this pratest';
$string['numberabbr'] = '#';
...
$string['openafterclose'] = 'Could not update the pratest. You have specified an open date after the close date.';
$string['openclosedatesupdated'] = 'Practice Test open and close dates updated';
...
$string['orderingpratest'] = 'Order and paging';
$string['orderingpratestx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a pratest has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the pratest before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their pratest attempt before time expires. If the student is actively working on the pratest at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/pratest/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this pratest to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->pratest} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->pratest} - Override';
$string['pageshort'] = 'P';
$string['page-mod-pratest-x'] = 'Any pratest module page';
$string['page-mod-pratest-attempt'] = 'Attempt pratest page';
$string['page-mod-pratest-edit'] = 'Edit pratest page';
$string['page-mod-pratest-report'] = 'Any pratest report page';
$string['page-mod-pratest-review'] = 'Review pratest attempt page';
$string['page-mod-pratest-summary'] = 'Practice Test attempt summary page';
$string['page-mod-pratest-view'] = 'Practice Test information page';
...
$string['pluginadministration'] = 'Practice Test administration';
$string['pluginname'] = 'Practice Test';
$string['popup'] = 'Show pratest in a \'secure\' window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the pratest in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this pratest in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewpratest'] = 'Preview {$a}';
$string['previewpratestnow'] = 'Preview pratest now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The pratest activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:pratest'] = 'The pratest activity makes use of pratest reports.';
$string['privacy:metadata:pratest_attempts'] = 'Details about each attempt on a pratest.';
$string['privacy:metadata:pratest_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:pratest_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:pratest_attempts:preview'] = 'Whether this is a preview of the pratest.';
$string['privacy:metadata:pratest_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:pratest_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:pratest_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:pratest_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:pratest_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:pratest_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:pratest_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:pratest_grades'] = 'Details about the overall grade for this pratest.';
$string['privacy:metadata:pratest_grades:grade'] = 'The overall grade for this pratest.';
$string['privacy:metadata:pratest_grades:pratest'] = 'The pratest that was graded.';
$string['privacy:metadata:pratest_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:pratest_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:pratest_overrides'] = 'Details about overrides for this pratest';
$string['privacy:metadata:pratest_overrides:pratest'] = 'The pratest with override information';
$string['privacy:metadata:pratest_overrides:timeclose'] = 'The new close time for the pratest.';
$string['privacy:metadata:pratest_overrides:timelimit'] = 'The new time limit for the pratest.';
$string['privacy:metadata:pratest_overrides:timeopen'] = 'The new open time for the pratest.';
$string['privacy:metadata:pratest_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:pratestaccess'] = 'The pratest activity makes use of pratest access rules.';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->pratestnames}<br />The question will not be deleted from these pratestzes but only from the category list.';
...
$string['questionsinthispratest'] = 'Questions in this pratest';
...
$string['pratest:addinstance'] = 'Add a new pratest';
$string['pratest:attempt'] = 'Attempt pratestzes';
$string['pratestavailable'] = 'The pratest is available until: {$a}';
$string['pratestclose'] = 'Close the pratest';
$string['pratestclosed'] = 'This pratest closed on {$a}';
$string['pratestcloses'] = 'Practice Test closes';
$string['pratesteventcloses'] = '{$a} closes';
$string['pratestcloseson'] = 'This pratest will close at {$a}';
$string['pratest:deleteattempts'] = 'Delete pratest attempts';
$string['pratest:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['pratest:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['pratest:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['pratest:grade'] = 'Grade pratestzes manually';
$string['pratest:ignoretimelimits'] = 'Ignores time limit on pratestzes';
$string['pratestisclosed'] = 'This pratest is closed';
$string['pratestisopen'] = 'This pratest is open';
$string['pratestisclosedwillopen'] = 'Practice Test closed (opens {$a})';
$string['pratestisopenwillclose'] = 'Practice Test open (closes {$a})';
$string['pratest:manage'] = 'Manage pratestzes';
$string['pratest:manageoverrides'] = 'Manage pratest overrides';
$string['pratestnavigation'] = 'Practice Test navigation';
$string['pratestopen'] = 'Open the pratest';
$string['pratesteventopens'] = '{$a} opens';
$string['pratestopenclose'] = 'Open and close dates';
$string['pratestopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['pratestopenclose_link'] = 'mod/pratest/timing';
$string['pratestopened'] = 'This pratest is open.';
$string['pratestopenedon'] = 'This pratest opened at {$a}';
$string['pratestopens'] = 'Practice Test opens';
$string['pratestopenwillclose'] = 'This pratest is open, will close on {$a} at';
$string['pratestordernotrandom'] = 'Order of pratest not shuffled';
$string['pratestorderrandom'] = '* Order of pratest is shuffled';
$string['pratest:preview'] = 'Preview pratestzes';
$string['pratest:regrade'] = 'Regrade pratest attempts';
$string['pratest:reviewmyattempts'] = 'Review your own attempts';
$string['pratestsettings'] = 'Practice Test settings';
$string['pratest:view'] = 'View pratest information';
$string['pratest:viewreports'] = 'View pratest reports';
$string['pratesttimer'] = 'Practice Test Timer';
$string['pratestwillopen'] = 'This pratest will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole pratest to be graded.  Are you sure you want to continue?';
$string['reattemptpratest'] = 'Re-attempt pratest';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this pratest';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingpratest'] = 'Regrading pratest "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallpratestattempts'] = 'Delete all pratest attempts';
...
$string['reportusersall'] = 'all users who have attempted the pratest';
$string['reportuserswith'] = 'enrolled users who have attempted the pratest';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the pratest';
$string['reportuserswithout'] = 'enrolled users who have not attempted the pratest';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the pratest.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Practice Test access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) pratest, to ensure that only people in a certain location can access the pratest.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to pratest defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after pratest is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while pratest is open';
$string['reviewclosed'] = 'After the pratest is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->pratest} by {$a->user}';
$string['reviewopen'] = 'Later, while the pratest is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a pratest attempt or look at the pratest reports.
...
**Later, while the pratest is still open** settings apply after this, and before the pratest close date.

**After the pratest is closed** settings apply after the pratest close date has passed. If the pratest does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current pratest attempt.';
...
$string['savepratest'] = 'Save this whole pratest';
...
$string['search:activity'] = 'Practice Test - activity information';
...
$string['showblocks'] = 'Show blocks during pratest attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during pratest attempts';
...
$string['shufflequestions_help'] = 'If you turn this on, then every time the pratest is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the pratest, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonpratest'] = 'Specified question is not on the specified pratest';
...
$string['subneterror'] = 'Sorry, this pratest has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this pratest.';
$string['subnetnotice'] = 'This pratest has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_pratest'] = 'Report';
$string['subplugintype_pratest_plural'] = 'Reports';
$string['subplugintype_pratestaccess'] = 'Access rule';
$string['subplugintype_pratestaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the pratest.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the pratest since you have not passed the time delay before attempting another pratest';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial pratest page and a countdown timer is displayed in the pratest navigation block.';
$string['timelimit_link'] = 'mod/pratest/timing';
$string['timelimitexeeded'] = 'Sorry! Practice Test time limit exceeded!';
...
$string['updatesettings'] = 'Update pratest settings';
$string['updatepratestslotswithrandomxofy'] = 'Updating pratest slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the pratest module will perform an extensive change of the pratest tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingpratestattempts'] = 'Upgrading pratest attempts: pratest {$a->done}/{$a->outof} (Practice Test id {$a->info})';
$string['upgradingveryoldpratestattempts'] = 'Upgrading very old pratest attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this pratest';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} pratest attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this pratest';
$string['yourfinalgradeis'] = 'Your final grade for this pratest is {$a}.';
