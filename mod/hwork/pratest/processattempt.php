...
/**
 * This page deals with processing responses during an attempt at a pratest.
 *
...
if ($attemptobj->is_finished()) {
    throw new moodle_pratest_exception($attemptobj->get_pratestobj(),
...
if ($status == pratest_attempt::OVERDUE) {
    redirect($attemptobj->summary_url());
} else if ($status == pratest_attempt::IN_PROGRESS) {
    redirect($nexturl);
} else {
