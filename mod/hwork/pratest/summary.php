...
/**
 * This page prints a summary of a pratest attempt before it is submitted.
 *
 * @package   mod_pratest
...
$PAGE->set_url('/mod/pratest/summary.php', array('attempt' => $attemptid));
...
$navbc = $attemptobj->get_navigation_panel($output, 'pratest_attempt_nav_panel', -1);
$regions = $PAGE->blocks->get_regions();
$PAGE->blocks->add_fake_block($navbc, reset($regions));

$PAGE->navbar->add(get_string('summaryofattempt', 'pratest'));
