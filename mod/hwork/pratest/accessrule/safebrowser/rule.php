...
/**
 * Implementaton of the pratestaccess_safebrowser plugin.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class pratestaccess_safebrowser extends pratest_access_rule_base {

    public static function make(pratest $pratestobj, $timenow, $canignoretimelimits) {

        if ($pratestobj->get_pratest()->browsersecurity !== 'safebrowser') {
            return null;
        }
    ...
    public function prevent_access() {
        if (!$this->check_safe_browser()) {
            return get_string('safebrowsererror', 'pratestaccess_safebrowser');
        } else {
            return false;
        }
    }
    ...
    public function description() {
        return get_string('safebrowsernotice', 'pratestaccess_safebrowser');
    }
    ...
    public static function get_browser_security_choices() {
        ...
        return array('safebrowser' =>
                get_string('requiresafeexambrowser', 'pratestaccess_safebrowser'));
    }
}
