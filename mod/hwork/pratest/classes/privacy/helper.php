...
/**
 * Privacy Subsystem helper for mod_pratest.
 *
 * @package    mod_pratest
...
class helper {
    /**
     * Determine the subcontext for the specified pratest attempt.
     *
     * @param   \stdClass       $attempt    The attempt data retrieved from the database.
     * @param   \stdClass       $user       The user record.
     * @return  \array                      The calculated subcontext.
     */
    public static function get_pratest_attempt_subcontext(\stdClass $attempt, \stdClass $user) {
        $subcontext = [
