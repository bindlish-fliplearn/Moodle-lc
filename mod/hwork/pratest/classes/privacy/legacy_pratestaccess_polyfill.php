 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
trait legacy_pratestaccess_polyfill {
    ...
    public static function export_pratestaccess_user_data(\pratest $pratest, \stdClass $user) : \stdClass {
        return static::_export_pratestaccess_user_data($pratest, $user);
    }
    ...
    public static function delete_pratestaccess_data_for_all_users_in_context(\pratest $pratest) {
        static::_delete_pratestaccess_data_for_all_users_in_context($pratest);
    }
    ...
    public static function delete_pratestaccess_data_for_user(\pratest $pratest, \stdClass $user) {
        static::_delete_pratestaccess_data_for_user($pratest, $user);
    }
     ...
     */
    public static function delete_pratestaccess_data_for_users(approved_userlist $userlist) {
        static::_delete_pratestaccess_data_for_users($userlist);
    }
}
