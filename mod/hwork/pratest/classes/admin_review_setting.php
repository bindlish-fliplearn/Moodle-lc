...
/**
 * Admin settings class for the pratest review options.
 *
 * @package   mod_pratest
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_pratest_admin_review_setting extends admin_setting {
    /**
     * @var integer should match the constants defined in
     * {@link mod_pratest_display_options}. Copied for performance reasons.
     */
    ...
    /**
     * This should match {@link mod_pratest_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return array(
            'attempt'          => get_string('theattempt', 'pratest'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'pratest'),
        );
    }
    ...
    protected static function times() {
        return array(
            self::DURING            => get_string('reviewduring', 'pratest'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'pratest'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'pratest'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'pratest'),
        );
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'pratest'), $query);
    }
}
