...
/**
 * The mod_pratest attempt started event.
 *
 * @package    mod_pratest
...
/**
 * The mod_pratest attempt started event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int pratestid: (optional) the id of the pratest.
 * }
 *
 * @package    mod_pratest
 * @since      Moodle 2.6
...
class attempt_started extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has started the attempt with id '$this->objectid' for the " .
            "pratest with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventpratestattemptstarted', 'mod_pratest');
    }
    ...
    static public function get_legacy_eventname() {
        return 'pratest_attempt_started';
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/pratest/review.php', array('attempt' => $this->objectid));
    }
    ...
    protected function get_legacy_eventdata() {
        $attempt = $this->get_record_snapshot('pratest_attempts', $this->objectid);

        $legacyeventdata = new \stdClass();
        $legacyeventdata->component = 'mod_pratest';
        ...
        $legacyeventdata->pratestid = $attempt->pratest;
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'pratest', 'attempt', 'review.php?attempt=' . $this->objectid,
            $attempt->pratest, $this->contextinstanceid);
    }
