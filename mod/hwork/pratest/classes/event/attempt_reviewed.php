...
/**
 * The mod_pratest attempt reviewed event.
 *
 * @package    mod_pratest
...
/**
 * The mod_pratest attempt reviewed event class.
 *
...
class attempt_reviewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptreviewed', 'mod_pratest');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'pratest', 'review', 'review.php?attempt=' . $this->objectid,
