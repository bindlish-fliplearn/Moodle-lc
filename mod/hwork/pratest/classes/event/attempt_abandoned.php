...
/**
 * The mod_pratest attempt abandoned event.
 *
 * @package    mod_pratest
...
/**
 * The mod_pratest attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int pratestid: (optional) id of the pratest.
 * }
 *
 * @package    mod_pratest
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the pratest with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventpratestattemptabandoned', 'mod_pratest');
    }
    ...
    static public function get_legacy_eventname() {
        return 'pratest_attempt_abandoned';
    }
