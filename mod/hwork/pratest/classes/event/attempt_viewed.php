...
/**
 * The mod_pratest attempt viewed event.
 *
 * @package    mod_pratest
...
/**
 * The mod_pratest attempt viewed event class.
 *
...
class attempt_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptviewed', 'mod_pratest');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the attempt with id '$this->objectid' belonging to the user " .
            "with id '$this->relateduserid' for the pratest with course module id '$this->contextinstanceid'.";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'pratest', 'continue attempt', 'review.php?attempt=' . $this->objectid,
