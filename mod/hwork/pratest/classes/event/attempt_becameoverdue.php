...
/**
 * The mod_pratest attempt became overdue event.
 *
 * @package    mod_pratest
...
/**
 * The mod_pratest attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The pratest attempt with id '$this->objectid' belonging to the pratest with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventpratestattempttimelimitexceeded', 'mod_pratest');
    }
    ...
    static public function get_legacy_eventname() {
        return 'pratest_attempt_overdue';
    }
