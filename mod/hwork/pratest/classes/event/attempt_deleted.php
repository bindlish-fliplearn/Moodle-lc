...
/**
 * The mod_pratest attempt deleted event.
 *
 * @package    mod_pratest
...
/**
 * The mod_pratest attempt deleted event class.
 *
...
class attempt_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptdeleted', 'mod_pratest');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the attempt with id '$this->objectid' belonging to the pratest " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'pratest', 'delete attempt', 'report.php?id=' . $this->contextinstanceid,
