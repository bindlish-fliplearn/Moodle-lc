...
/**
 * Base class for pratest report plugins.
 *
 * @package   mod_pratest
 ...
 * This class displays pratest reports.  Because it is called from
 * within /mod/pratest/report.php you can assume that the page header
 * and footer are taken care of.
 *
 * This file can refer to itself as report.php to pass variables
 * to itself - all these will also be globally available.  You must
 * pass "id=$cm->id" or q=$pratest->id", and "mode=reportname".
 *
 * @copyright 1999 onwards Martin Dougiamas and others {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class pratest_default_report {
    const NO_GROUPS_ALLOWED = -2;

    /**
     * Override this function to displays the report.
     * @param $cm the course-module for this pratest.
     * @param $course the coures we are in.
     * @param $pratest this pratest.
     */
    public abstract function display($cm, $course, $pratest);
     ...
     */
    public function print_header_and_tabs($cm, $course, $pratest, $reportmode = 'overview') {
        global $PAGE, $OUTPUT;

        // Print the page header.
        $PAGE->set_title($pratest->name);
