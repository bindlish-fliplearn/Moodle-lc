...
/**
 * Class to store the options for a {@link pratest_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class pratest_overview_options extends mod_pratest_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('pratest_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (pratest_has_grades($this->pratest)) {
            set_user_preference('pratest_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/pratest:regrade', 'mod/pratest:deleteattempts'), context_module::instance($this->cm->id))
