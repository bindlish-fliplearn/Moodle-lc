YUI.add('moodle-mod_pratest-pratestbase', function (Y, NAME) {

/**
 * The pratestbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_pratest-pratestbase
 */
var QUIZBASENAME = 'mod_pratest-pratestbase';
...
M.mod_pratest.pratestbase = M.mod_pratest.pratestbase || new QUIZBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_pratest.edit = M.mod_pratest.edit || {};
 ...
 */
M.mod_pratest.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_pratest.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
