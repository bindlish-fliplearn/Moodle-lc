YUI.add('moodle-mod_hwork-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_hwork-questionchooser'
});

M.mod_hwork = M.mod_hwork || {};
M.mod_hwork.init_questionchooser = function() {
    M.mod_hwork.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_hwork.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_hwork-util", "querystring-parse"]});
