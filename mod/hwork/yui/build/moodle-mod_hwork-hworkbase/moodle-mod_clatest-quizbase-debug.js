YUI.add('moodle-mod_hwork-hworkbase', function (Y, NAME) {

/**
 * The hworkbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_hwork-hworkbase
 */
var QUIZBASENAME = 'mod_hwork-hworkbase';
...
M.mod_hwork.hworkbase = M.mod_hwork.hworkbase || new QUIZBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_hwork.edit = M.mod_hwork.edit || {};
 ...
 */
M.mod_hwork.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_hwork.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
