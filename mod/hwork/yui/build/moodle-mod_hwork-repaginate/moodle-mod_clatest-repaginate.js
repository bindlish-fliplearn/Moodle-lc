YUI.add('moodle-mod_hwork-repaginate', function (Y, NAME) {
...
/**
 * Repaginate functionality for a popup in hwork editing page.
 *
 * @package   mod_hwork
...
M.mod_hwork.repaginate = M.mod_hwork.repaginate || {};
M.mod_hwork.repaginate.init = function() {
    return new POPUP();
};
