...
/**
 * Base class for rules that restrict the ability to attempt a hwork.
 *
 * @package   mod_hwork
...
/**
 * A base class that defines the interface for the various hwork access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class hwork_access_rule_base {
    /** @var stdClass the hwork settings. */
    protected $hwork;
    /** @var hwork the hwork object. */
    protected $hworkobj;
    /** @var int the time to use as 'now'. */
    protected $timenow;

    /**
     * Create an instance of this rule for a particular hwork.
     * @param hwork $hworkobj information about the hwork in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($hworkobj, $timenow) {
        $this->hworkobj = $hworkobj;
        $this->hwork = $hworkobj->get_hwork();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given hwork, otherwise return null.
     * @param hwork $hworkobj information about the hwork in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/hwork:ignoretimelimits capability.
     * @return hwork_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_hwork_preflight_check_form $hworkform the form being built.
    ...
    /**
     * This is called when the current attempt at the hwork is finished. This is
    ...
    /**
     * Information, such as might be shown on the hwork view page, relating to this restriction.
     ...
     * this hwork, then return true. This is used so we can know whether to display a
    ...
    /**
     * Add any fields that this rule requires to the hwork settings form. This
     * method is called from {@link mod_hwork_mod_form::definition()}, while the
    ...
    /**
     * @return array key => lang string any choices to add to the hwork Browser
    ...
    /**
     * Save any submitted settings when the hwork settings form is submitted. This
     * is called from {@link hwork_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the hwork is deleted. This is called
     * from {@link hwork_delete_instance()} in lib.php.
     ...
     * here is probalby to read the code of {@link hwork_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $hworkid the id of the hwork we are loading settings for. This
     *     can also be accessed as hwork.id in the SQL. (hwork is a table alisas for {hwork}.)
     ...
     */
    public static function get_settings_sql($hworkid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($hworkid) {
        return array();
    }
}
