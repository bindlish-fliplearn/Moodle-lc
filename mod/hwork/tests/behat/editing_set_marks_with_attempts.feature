@mod @mod_hwork
Feature: Edit hwork marks with attempts
  In order to create a hwork that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit hwork page (even after the hwork has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | hwork       | Quiz 1 | C1     | hwork1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add a "True/False" question to the "Quiz 1" hwork with:
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the hwork settings say it should be.
