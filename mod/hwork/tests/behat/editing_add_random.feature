@mod @mod_hwork @javascript
Feature: Adding random questions to a hwork based on category and tags
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | hwork       | Quiz 1 | Quiz 1 for testing the Add random question form | C1     | hwork1    |
