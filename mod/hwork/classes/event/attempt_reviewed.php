...
/**
 * The mod_hwork attempt reviewed event.
 *
 * @package    mod_hwork
...
/**
 * The mod_hwork attempt reviewed event class.
 *
...
class attempt_reviewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptreviewed', 'mod_hwork');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'hwork', 'review', 'review.php?attempt=' . $this->objectid,
