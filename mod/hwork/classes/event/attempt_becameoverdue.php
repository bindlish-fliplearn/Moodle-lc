...
/**
 * The mod_hwork attempt became overdue event.
 *
 * @package    mod_hwork
...
/**
 * The mod_hwork attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The hwork attempt with id '$this->objectid' belonging to the hwork with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventhworkattempttimelimitexceeded', 'mod_hwork');
    }
