...
/**
 * The mod_hwork attempt submitted event.
 *
 * @package    mod_hwork
...
/**
 * The mod_hwork attempt submitted event class.
 *
...
class attempt_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventhworkattemptsubmitted', 'mod_hwork');
    }
    ...
    static public function get_legacy_eventname() {
        return 'hwork_attempt_submitted';
    }
