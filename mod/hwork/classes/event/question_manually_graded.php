...
/**
 * The mod_hwork question manually graded event.
 *
 * @package    core
...
/**
 * The mod_hwork question manually graded event class.
 *
...
class question_manually_graded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquestionmanuallygraded', 'mod_hwork');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' manually graded the question with id '$this->objectid' for the attempt " .
            "with id '{$this->other['attemptid']}' for the hwork with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/hwork/comment.php', array('attempt' => $this->other['attemptid'],
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'hwork', 'manualgrade', 'comment.php?attempt=' . $this->other['attemptid'] .
            '&slot=' . $this->other['slot'], $this->other['hworkid'], $this->contextinstanceid);
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['hworkid'])) {
            throw new \coding_exception('The \'hworkid\' value must be set in other.');
        }
    ...
    public static function get_other_mapping() {
        ...
        $othermapped['attemptid'] = array('db' => 'hwork_attempts', 'restore' => 'hwork_attempt');
