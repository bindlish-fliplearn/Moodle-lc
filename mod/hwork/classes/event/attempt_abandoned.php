...
/**
 * The mod_hwork attempt abandoned event.
 *
 * @package    mod_hwork
...
/**
 * The mod_hwork attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int hworkid: (optional) id of the hwork.
 * }
 *
 * @package    mod_hwork
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the hwork with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventhworkattemptabandoned', 'mod_hwork');
    }
    ...
    static public function get_legacy_eventname() {
        return 'hwork_attempt_abandoned';
    }
