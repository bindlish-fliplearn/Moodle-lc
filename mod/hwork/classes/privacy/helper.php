...
/**
 * Privacy Subsystem helper for mod_hwork.
 *
 * @package    mod_hwork
...
class helper {
    /**
     * Determine the subcontext for the specified hwork attempt.
     *
     * @param   \stdClass       $attempt    The attempt data retrieved from the database.
     * @param   \stdClass       $user       The user record.
     * @return  \array                      The calculated subcontext.
     */
    public static function get_hwork_attempt_subcontext(\stdClass $attempt, \stdClass $user) {
        $subcontext = [
