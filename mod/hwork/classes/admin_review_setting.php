...
/**
 * Admin settings class for the hwork review options.
 *
 * @package   mod_hwork
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_hwork_admin_review_setting extends admin_setting {
    /**
     * @var integer should match the constants defined in
     * {@link mod_hwork_display_options}. Copied for performance reasons.
     */
    ...
    /**
     * This should match {@link mod_hwork_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return array(
            'attempt'          => get_string('theattempt', 'hwork'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'hwork'),
        );
    }
    ...
    protected static function times() {
        return array(
            self::DURING            => get_string('reviewduring', 'hwork'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'hwork'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'hwork'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'hwork'),
        );
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'hwork'), $query);
    }
}
