...
/**
 * Cognitive depth indicator - hwork.
 *
 * @package   mod_hwork
...
namespace mod_hwork\analytics\indicator;
...
class cognitive_depth extends activity_base {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('indicator:cognitivedepth', 'mod_hwork');
    }
    ...
    protected function feedback_submitted_events() {
        return array('\mod_hwork\event\attempt_submitted');
    }
