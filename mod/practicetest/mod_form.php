...
/**
 * The main practicetest configuration form
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_practicetest_mod_form extends moodleform_mod {
...
//comment below line & uncomment above (Change by Jatin)          
        $mform->addElement('hidden', 'quizpassword', get_string('requirepassword', 'quiz'));
