...
/**
 * This page prints a summary of a clatest attempt before it is submitted.
 *
 * @package   mod_clatest
...
$PAGE->set_url('/mod/clatest/summary.php', array('attempt' => $attemptid));
...
$navbc = $attemptobj->get_navigation_panel($output, 'clatest_attempt_nav_panel', -1);
$regions = $PAGE->blocks->get_regions();
$PAGE->blocks->add_fake_block($navbc, reset($regions));

$PAGE->navbar->add(get_string('summaryofattempt', 'clatest'));
