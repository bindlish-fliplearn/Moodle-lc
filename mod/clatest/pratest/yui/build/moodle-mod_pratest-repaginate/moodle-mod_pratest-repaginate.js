YUI.add('moodle-mod_pratest-repaginate', function (Y, NAME) {
...
/**
 * Repaginate functionality for a popup in pratest editing page.
 *
 * @package   mod_pratest
...
M.mod_pratest.repaginate = M.mod_pratest.repaginate || {};
M.mod_pratest.repaginate.init = function() {
    return new POPUP();
};
