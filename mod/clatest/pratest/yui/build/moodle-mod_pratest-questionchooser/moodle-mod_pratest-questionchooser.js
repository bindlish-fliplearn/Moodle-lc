YUI.add('moodle-mod_pratest-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_pratest-questionchooser'
});

M.mod_pratest = M.mod_pratest || {};
M.mod_pratest.init_questionchooser = function() {
    M.mod_pratest.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_pratest.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_pratest-util", "querystring-parse"]});
