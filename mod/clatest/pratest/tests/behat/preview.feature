@mod @mod_pratest
Feature: Preview a pratest as a teacher
  In order to verify my pratestzes are ready for my students
  As a teacher
  ...
  @javascript
  Scenario: Preview a pratest
    When I follow "Quiz 1"
    And I press "Preview pratest now"
