 ...
 *
 * @module    mod_clatest/random_question_form_preview
 * @package   mod_clatest
...
define(
    ...
    var TEMPLATE_NAME = 'mod_clatest/random_question_form_preview_question_list';
    var SELECTORS = {
    ...
    var renderQuestionCount = function(root, questionCount) {
        Str.get_string('questionsmatchingfilter', 'mod_clatest', questionCount)
