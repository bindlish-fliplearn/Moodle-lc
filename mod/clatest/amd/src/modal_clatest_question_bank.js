 ...
 *
 * @module     mod_clatest/modal_clatest_question_bank
 * @package    mod_clatest
...
function(
    ...
    var SELECTORS = {
        ADD_TO_QUIZ_CONTAINER: 'td.addtoclatestaction',
        ANCHOR: 'a[href]',
    ...
    ModalQuizQuestionBank.TYPE = 'mod_clatest-clatest-question-bank';
     ...
     * when the user clicks the add to clatest link.
     *
     ...
     *      - The clatest category select box
    ...
    ModalQuizQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to clatest link.
