 ...
 *
 * This is also responsible for opening the pop-up window, if the clatest requires to be in one.
 *
 * @module    mod_clatest/preflightcheck
...
define(['jquery', 'core/yui'], function($, Y) {
    ...
    /**
     * @alias module:mod_clatest/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the clatest should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_clatest_preflight_popup']
                    });
        ...
        /**
         * Event handler for the clatest start attempt button.
