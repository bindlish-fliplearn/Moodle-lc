...
/**
 * Strings for component 'clatest', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_clatest
...
$string['accessnoticesheader'] = 'You can preview this clatest, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have clatestzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the clatest. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the clatest. This means that different students are likely to get a different selection of questions, and when a clatest allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any clatest in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your clatest over on the other side of this page.</p>';
...
$string['addquestionstoclatest'] = 'Add questions to current clatest';
...
$string['addrandomquestiontoclatest'] = 'Add a random question to clatest {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstoclatest'] = 'Add selected questions to the clatest';
$string['addselectedtoclatest'] = 'Add selected to clatest';
$string['addtoclatest'] = 'Add to clatest';
...
$string['attempterror'] = 'You are not allowed to attempt this clatest at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid clatest attempt ID';
$string['attempterrorcontentchange'] = 'This clatest preview no longer exists. (When a clatest is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This clatest attempt no longer exists.';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptclatestnow'] = 'Attempt clatest now';
$string['attempts'] = 'Attempts';
$string['attempts_help'] = 'The total number of attempts allowed (not the number of extra attempts).';
$string['attemptsallowed'] = 'Attempts allowed';
$string['attemptsdeleted'] = 'Class Test attempts deleted';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during clatest attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtoclatest'] = 'Back to clatest editing';
$string['basicideasofclatest'] = 'The basic ideas of clatest-making';
...
* The clatest will only start if the student has a JavaScript-enabled web-browser
* The clatest appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this clatest has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the clatest';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this clatest. The clatest is set to be graded out of {$a->grade}, but none of the questions in the clatest have a grade. This can be fixed on the \'Edit clatest\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this clatest. The clatest definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this clatest. The clatest has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire clatest attempt and start another one. This option is mainly useful for practice clatestzes.
...
$string['canredoquestions_help'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire clatest attempt and start another one. This option is mainly useful for practice clatestzes.
...
$string['closebeforeopen'] = 'Could not update the clatest. You have specified a close date before the open date.';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the clatest settings) or higher.';
...
$string['completionattemptsexhausted_help'] = 'Mark clatest complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the clatest.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the clatest.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the clatest.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a clatest after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the clatest.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new clatest. You can also configure which clatest settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the clatest grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the clatest page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the clatest editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during clatest attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the clatest.';
$string['configrequiresubnet'] = 'Students can only attempt the clatest from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a clatest attempt or look at the clatest reports.';
$string['configshowblocks'] = 'Show blocks during clatest attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this clatest, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for clatestzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for clatestzes in seconds. 0 mean no time limit.';
...
$string['continueattemptclatest'] = 'Continue the last attempt';
...
$string['countdownfinished'] = 'The clatest is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The clatest will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to clatest';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the clatest.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the clatest a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the clatest a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/clatest folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new clatest attempt will contain the results of the previous attempt. This allows a clatest to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingclatest'] = 'Editing clatest';
$string['editingclatest_help'] = 'When creating a clatest, the main concepts are:

* The clatest, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the clatest and different students can get different questions';
$string['editingclatest_link'] = 'mod/clatest/edit';
$string['editingclatestx'] = 'Editing clatest: {$a}';
...
$string['editclatest'] = 'Edit clatest';
$string['editclatestquestions'] = 'Edit clatest questions';
$string['emailconfirmbody'] = 'Hi {$a->username},

Thank you for submitting your answers to \'{$a->clatestname}\' in course \'{$a->coursename}\' at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this clatest at {$a->clatesturl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->clatestname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->clatestname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->clatestname}\' ({$a->clatesturl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->clatestreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->clatestname}. See {$a->clatestreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->clatestname}';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->clatestname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->clatestname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->clatestname}';
$string['empty'] = 'Empty';
...
$string['eventattemptdeleted'] = 'Class Test attempt deleted';
$string['eventattemptpreviewstarted'] = 'Class Test attempt preview started';
$string['eventattemptreviewed'] = 'Class Test attempt reviewed';
$string['eventattemptsummaryviewed'] = 'Class Test attempt summary viewed';
$string['eventattemptviewed'] = 'Class Test attempt viewed';
$string['eventeditpageviewed'] = 'Class Test edit page viewed';
$string['eventoverridecreated'] = 'Class Test override created';
$string['eventoverridedeleted'] = 'Class Test override deleted';
$string['eventoverrideupdated'] = 'Class Test override updated';
$string['eventquestionmanuallygraded'] = 'Question manually graded';
$string['eventclatestattemptabandoned'] = 'Class Test attempt abandoned';
$string['eventclatestattempttimelimitexceeded'] = 'Class Test attempt time limit exceeded';
$string['eventclatestattemptstarted'] = 'Class Test attempt started';
$string['eventclatestattemptsubmitted'] = 'Class Test attempt submitted';
$string['eventreportviewed'] = 'Class Test report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the clatest. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the clatest when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the clatest. You have to make a trade-off based on how much you trust the performance of your server during clatestzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final clatest grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'Class Test grades deleted';
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->clatestgrade}.';
$string['gradetopassnotset'] = 'This clatest does not yet have a grade to pass set. It may be set in the Grade section of the clatest settings.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this clatest has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt clatestzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a clatest.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the clatest';
$string['incorrect'] = 'Incorrect';
$string['indicator:cognitivedepth'] = 'Class Test cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a Class Test activity.';
$string['indicator:socialbreadth'] = 'Class Test social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a Class Test activity.';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new clatest, provide this many blank overall feedback boxes. Once the clatest has been created, the form shows the number of fields required for the number of feedbacks in the clatest. The setting must be at least 1.';
...
$string['invalidclatestid'] = 'Invalid clatest ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in clatest';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->clatest} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your clatest attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own clatest submissions';
$string['messageprovider:submission'] = 'Notification of clatest submissions';
$string['max'] = 'Max';
...
$string['modulename_help'] = 'The clatest activity enables a teacher to create clatestzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the clatest to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/clatest/view';
$string['modulenameplural'] = 'Class Testzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the clatest in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the clatest';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer clatestzes it makes sense to stretch the clatest over several pages by limiting the number of questions per page. When adding questions to the clatest, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this clatest';
...
$string['nogradewarning'] = 'This clatest is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the clatest settings.';
...
$string['noquestionsinclatest'] = 'There are no questions in this clatest.';
...
$string['noreview'] = 'You are not allowed to review this clatest';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this clatest until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This clatest is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the clatest module. As a work around, set a time limit for the whole clatest. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this clatest';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this clatest';
$string['numberabbr'] = '#';
...
$string['openafterclose'] = 'Could not update the clatest. You have specified an open date after the close date.';
$string['openclosedatesupdated'] = 'Class Test open and close dates updated';
...
$string['orderingclatest'] = 'Order and paging';
$string['orderingclatestx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a clatest has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the clatest before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their clatest attempt before time expires. If the student is actively working on the clatest at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/clatest/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this clatest to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->clatest} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->clatest} - Override';
$string['pageshort'] = 'P';
$string['page-mod-clatest-x'] = 'Any clatest module page';
$string['page-mod-clatest-attempt'] = 'Attempt clatest page';
$string['page-mod-clatest-edit'] = 'Edit clatest page';
$string['page-mod-clatest-report'] = 'Any clatest report page';
$string['page-mod-clatest-review'] = 'Review clatest attempt page';
$string['page-mod-clatest-summary'] = 'Class Test attempt summary page';
$string['page-mod-clatest-view'] = 'Class Test information page';
...
$string['pluginadministration'] = 'Class Test administration';
$string['pluginname'] = 'Class Test';
$string['popup'] = 'Show clatest in a \'secure\' window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the clatest in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this clatest in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewclatest'] = 'Preview {$a}';
$string['previewclatestnow'] = 'Preview clatest now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The clatest activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:clatest'] = 'The clatest activity makes use of clatest reports.';
$string['privacy:metadata:clatest_attempts'] = 'Details about each attempt on a clatest.';
$string['privacy:metadata:clatest_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:clatest_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:clatest_attempts:preview'] = 'Whether this is a preview of the clatest.';
$string['privacy:metadata:clatest_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:clatest_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:clatest_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:clatest_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:clatest_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:clatest_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:clatest_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:clatest_grades'] = 'Details about the overall grade for this clatest.';
$string['privacy:metadata:clatest_grades:grade'] = 'The overall grade for this clatest.';
$string['privacy:metadata:clatest_grades:clatest'] = 'The clatest that was graded.';
$string['privacy:metadata:clatest_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:clatest_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:clatest_overrides'] = 'Details about overrides for this clatest';
$string['privacy:metadata:clatest_overrides:clatest'] = 'The clatest with override information';
$string['privacy:metadata:clatest_overrides:timeclose'] = 'The new close time for the clatest.';
$string['privacy:metadata:clatest_overrides:timelimit'] = 'The new time limit for the clatest.';
$string['privacy:metadata:clatest_overrides:timeopen'] = 'The new open time for the clatest.';
$string['privacy:metadata:clatest_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:clatestaccess'] = 'The clatest activity makes use of clatest access rules.';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->clatestnames}<br />The question will not be deleted from these clatestzes but only from the category list.';
...
$string['questionsinthisclatest'] = 'Questions in this clatest';
...
$string['clatest:addinstance'] = 'Add a new clatest';
$string['clatest:attempt'] = 'Attempt clatestzes';
$string['clatestavailable'] = 'The clatest is available until: {$a}';
$string['clatestclose'] = 'Close the clatest';
$string['clatestclosed'] = 'This clatest closed on {$a}';
$string['clatestcloses'] = 'Class Test closes';
$string['clatesteventcloses'] = '{$a} closes';
$string['clatestcloseson'] = 'This clatest will close at {$a}';
$string['clatest:deleteattempts'] = 'Delete clatest attempts';
$string['clatest:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['clatest:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['clatest:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['clatest:grade'] = 'Grade clatestzes manually';
$string['clatest:ignoretimelimits'] = 'Ignores time limit on clatestzes';
$string['clatestisclosed'] = 'This clatest is closed';
$string['clatestisopen'] = 'This clatest is open';
$string['clatestisclosedwillopen'] = 'Class Test closed (opens {$a})';
$string['clatestisopenwillclose'] = 'Class Test open (closes {$a})';
$string['clatest:manage'] = 'Manage clatestzes';
$string['clatest:manageoverrides'] = 'Manage clatest overrides';
$string['clatestnavigation'] = 'Class Test navigation';
$string['clatestopen'] = 'Open the clatest';
$string['clatesteventopens'] = '{$a} opens';
$string['clatestopenclose'] = 'Open and close dates';
$string['clatestopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['clatestopenclose_link'] = 'mod/clatest/timing';
$string['clatestopened'] = 'This clatest is open.';
$string['clatestopenedon'] = 'This clatest opened at {$a}';
$string['clatestopens'] = 'Class Test opens';
$string['clatestopenwillclose'] = 'This clatest is open, will close on {$a} at';
$string['clatestordernotrandom'] = 'Order of clatest not shuffled';
$string['clatestorderrandom'] = '* Order of clatest is shuffled';
$string['clatest:preview'] = 'Preview clatestzes';
$string['clatest:regrade'] = 'Regrade clatest attempts';
$string['clatest:reviewmyattempts'] = 'Review your own attempts';
$string['clatestsettings'] = 'Class Test settings';
$string['clatest:view'] = 'View clatest information';
$string['clatest:viewreports'] = 'View clatest reports';
$string['clatesttimer'] = 'Class Test Timer';
$string['clatestwillopen'] = 'This clatest will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole clatest to be graded.  Are you sure you want to continue?';
$string['reattemptclatest'] = 'Re-attempt clatest';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this clatest';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingclatest'] = 'Regrading clatest "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallclatestattempts'] = 'Delete all clatest attempts';
...
$string['reportusersall'] = 'all users who have attempted the clatest';
$string['reportuserswith'] = 'enrolled users who have attempted the clatest';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the clatest';
$string['reportuserswithout'] = 'enrolled users who have not attempted the clatest';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the clatest.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Class Test access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) clatest, to ensure that only people in a certain location can access the clatest.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to clatest defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after clatest is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while clatest is open';
$string['reviewclosed'] = 'After the clatest is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->clatest} by {$a->user}';
$string['reviewopen'] = 'Later, while the clatest is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a clatest attempt or look at the clatest reports.
...
**Later, while the clatest is still open** settings apply after this, and before the clatest close date.

**After the clatest is closed** settings apply after the clatest close date has passed. If the clatest does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current clatest attempt.';
...
$string['saveclatest'] = 'Save this whole clatest';
...
$string['search:activity'] = 'Class Test - activity information';
...
$string['showblocks'] = 'Show blocks during clatest attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during clatest attempts';
...
$string['shufflequestions_help'] = 'If you turn this on, then every time the clatest is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the clatest, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonclatest'] = 'Specified question is not on the specified clatest';
...
$string['subneterror'] = 'Sorry, this clatest has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this clatest.';
$string['subnetnotice'] = 'This clatest has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_clatest'] = 'Report';
$string['subplugintype_clatest_plural'] = 'Reports';
$string['subplugintype_clatestaccess'] = 'Access rule';
$string['subplugintype_clatestaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the clatest.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the clatest since you have not passed the time delay before attempting another clatest';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial clatest page and a countdown timer is displayed in the clatest navigation block.';
$string['timelimit_link'] = 'mod/clatest/timing';
$string['timelimitexeeded'] = 'Sorry! Class Test time limit exceeded!';
...
$string['updatesettings'] = 'Update clatest settings';
$string['updateclatestslotswithrandomxofy'] = 'Updating clatest slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the clatest module will perform an extensive change of the clatest tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingclatestattempts'] = 'Upgrading clatest attempts: clatest {$a->done}/{$a->outof} (Class Test id {$a->info})';
$string['upgradingveryoldclatestattempts'] = 'Upgrading very old clatest attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this clatest';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} clatest attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this clatest';
$string['yourfinalgradeis'] = 'Your final grade for this clatest is {$a}.';
