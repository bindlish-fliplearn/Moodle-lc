@mod @mod_clatest @clatest @clatest_overview
Feature: Basic use of the Grades report
  In order to easily get an overview of clatest attempts
  As a teacher
  ...
  Scenario: Using the Grades report
    ...
    And I set the field "Attempts from" to "enrolled users who have not attempted the clatest"
    ...
    And I set the field "Attempts from" to "enrolled users who have, or have not, attempted the clatest"
    And I press "Show report"
    # Check student1's grade
    And I should see "25.00" in the "S1 Student1" "table_row"
    ...
    And I set the field "Attempts from" to "all users who have attempted the clatest"
    And I press "Show report"
    # Check student1's grade
    And I should see "25.00" in the "S1 Student1" "table_row"
    # Check student2's grade
