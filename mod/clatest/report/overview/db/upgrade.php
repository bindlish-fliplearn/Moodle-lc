 ...
 */
function xmldb_clatest_overview_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2018061800) {
        ...
        // Define key questionusageid-slot (foreign) to be dropped form clatest_overview_regrades.
        $table = new xmldb_table('clatest_overview_regrades');
        ...
        upgrade_plugin_savepoint(true, 2018061800, 'clatest', 'overview');
    }

    if ($oldversion < 2018061801) {

        // Define key questionusageid-slot (foreign) to be added to clatest_overview_regrades.
        $table = new xmldb_table('clatest_overview_regrades');
        $key = new xmldb_key('questionusageid-slot', XMLDB_KEY_FOREIGN, array('questionusageid', 'slot'), 'question_attempts', array('questionusageid', 'slot'));
        ...
        // Overview savepoint reached.
        upgrade_plugin_savepoint(true, 2018061801, 'clatest', 'overview');
    }
