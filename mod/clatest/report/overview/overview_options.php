...
/**
 * Class to store the options for a {@link clatest_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class clatest_overview_options extends mod_clatest_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('clatest_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (clatest_has_grades($this->clatest)) {
            set_user_preference('clatest_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/clatest:regrade', 'mod/clatest:deleteattempts'), context_module::instance($this->cm->id))
