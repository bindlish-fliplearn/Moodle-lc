...
/**
 * Strings for component 'clatest_grading', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['gradingnotallowed'] = 'You do not have permission to manually grade responses in this clatest';
