...
/**
 * A {@link qubaid_condition} representing all the attempts by one user at a given clatest.
 *
 * @package   mod_clatest
 * @category  question
...
namespace mod_clatest\question;
...
class qubaids_for_users_attempts extends \qubaid_join {
     ...
     * Constructor.
     *
     * This takes the same arguments as {@link clatest_get_user_attempts()}.
     *
     ...
     */
    public function __construct($clatestid, $userid, $status = 'finished', $includepreviews = false) {
        $where = 'clatesta.clatest = :clatestaclatest AND clatesta.userid = :userid';
        $params = array('clatestaclatest' => $clatestid, 'userid' => $userid);
