...
/**
 * The mod_clatest attempt submitted event.
 *
 * @package    mod_clatest
...
/**
 * The mod_clatest attempt submitted event class.
 *
...
class attempt_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventclatestattemptsubmitted', 'mod_clatest');
    }
    ...
    static public function get_legacy_eventname() {
        return 'clatest_attempt_submitted';
    }
