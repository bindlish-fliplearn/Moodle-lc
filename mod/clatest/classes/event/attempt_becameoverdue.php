...
/**
 * The mod_clatest attempt became overdue event.
 *
 * @package    mod_clatest
...
/**
 * The mod_clatest attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The clatest attempt with id '$this->objectid' belonging to the clatest with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventclatestattempttimelimitexceeded', 'mod_clatest');
    }
    ...
    static public function get_legacy_eventname() {
        return 'clatest_attempt_overdue';
    }
