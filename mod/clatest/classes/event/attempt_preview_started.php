...
/**
 * The mod_clatest attempt preview started event.
 *
 * @package    mod_clatest
...
/**
 * The mod_clatest attempt preview started event class.
 *
...
class attempt_preview_started extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptpreviewstarted', 'mod_clatest');
    }
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' previewed by " .
            "the user with id '$this->userid' for the clatest with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/clatest/view.php', array('id' => $this->contextinstanceid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'clatest', 'preview', 'view.php?id=' . $this->contextinstanceid,
