...
/**
 * The mod_clatest attempt abandoned event.
 *
 * @package    mod_clatest
...
/**
 * The mod_clatest attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int clatestid: (optional) id of the clatest.
 * }
 *
 * @package    mod_clatest
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the clatest with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventclatestattemptabandoned', 'mod_clatest');
    }
    ...
    static public function get_legacy_eventname() {
        return 'clatest_attempt_abandoned';
    }
