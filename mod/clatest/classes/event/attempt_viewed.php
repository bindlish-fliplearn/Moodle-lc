...
/**
 * The mod_clatest attempt viewed event.
 *
 * @package    mod_clatest
...
/**
 * The mod_clatest attempt viewed event class.
 *
...
class attempt_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptviewed', 'mod_clatest');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'clatest', 'continue attempt', 'review.php?attempt=' . $this->objectid,
