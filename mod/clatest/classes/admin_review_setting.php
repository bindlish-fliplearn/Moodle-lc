...
/**
 * Admin settings class for the clatest review options.
 *
 * @package   mod_clatest
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_clatest_admin_review_setting extends admin_setting {
    /**
     * @var integer should match the constants defined in
     * {@link mod_clatest_display_options}. Copied for performance reasons.
     */
    ...
    /**
     * This should match {@link mod_clatest_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return array(
            'attempt'          => get_string('theattempt', 'clatest'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'clatest'),
        );
    }
    ...
    protected static function times() {
        return array(
            self::DURING            => get_string('reviewduring', 'clatest'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'clatest'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'clatest'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'clatest'),
        );
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'clatest'), $query);
    }
}
