 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
trait legacy_clatestaccess_polyfill {
    ...
    public static function export_clatestaccess_user_data(\clatest $clatest, \stdClass $user) : \stdClass {
        return static::_export_clatestaccess_user_data($clatest, $user);
    }
    ...
    public static function delete_clatestaccess_data_for_all_users_in_context(\clatest $clatest) {
        static::_delete_clatestaccess_data_for_all_users_in_context($clatest);
    }
    ...
    public static function delete_clatestaccess_data_for_user(\clatest $clatest, \stdClass $user) {
        static::_delete_clatestaccess_data_for_user($clatest, $user);
    }
     ...
     */
    public static function delete_clatestaccess_data_for_users(approved_userlist $userlist) {
        static::_delete_clatestaccess_data_for_users($userlist);
    }
}
