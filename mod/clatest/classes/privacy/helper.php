...
/**
 * Privacy Subsystem helper for mod_clatest.
 *
 * @package    mod_clatest
...
class helper {
    /**
     * Determine the subcontext for the specified clatest attempt.
     *
     * @param   \stdClass       $attempt    The attempt data retrieved from the database.
     * @param   \stdClass       $user       The user record.
     * @return  \array                      The calculated subcontext.
     */
    public static function get_clatest_attempt_subcontext(\stdClass $attempt, \stdClass $user) {
        $subcontext = [
