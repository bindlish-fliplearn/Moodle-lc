YUI.add('moodle-mod_clatest-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_clatest-questionchooser'
});

M.mod_clatest = M.mod_clatest || {};
M.mod_clatest.init_questionchooser = function() {
    M.mod_clatest.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_clatest.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_clatest-util", "querystring-parse"]});
