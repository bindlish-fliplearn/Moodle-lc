YUI.add('moodle-mod_clatest-clatestbase', function (Y, NAME) {

/**
 * The clatestbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_clatest-clatestbase
 */
var QUIZBASENAME = 'mod_clatest-clatestbase';
...
M.mod_clatest.clatestbase = M.mod_clatest.clatestbase || new QUIZBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_clatest.edit = M.mod_clatest.edit || {};
 ...
 */
M.mod_clatest.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_clatest.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
