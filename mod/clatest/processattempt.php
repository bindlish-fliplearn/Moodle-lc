...
/**
 * This page deals with processing responses during an attempt at a clatest.
 *
...
if ($attemptobj->is_finished()) {
    throw new moodle_clatest_exception($attemptobj->get_clatestobj(),
...
if ($status == clatest_attempt::OVERDUE) {
    redirect($attemptobj->summary_url());
} else if ($status == clatest_attempt::IN_PROGRESS) {
    redirect($nexturl);
} else {
