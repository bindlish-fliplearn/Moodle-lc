@mod @mod_clatest
Feature: Edit clatest marks with attempts
  In order to create a clatest that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit clatest page (even after the clatest has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | clatest       | Quiz 1 | C1     | clatest1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add a "True/False" question to the "Quiz 1" clatest with:
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the clatest settings say it should be.
