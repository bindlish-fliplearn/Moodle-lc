@mod @mod_clatest @javascript
Feature: Quiz user override
  In order to grant a student special access to a clatest
  As a teacher
  ...
  Scenario: Being able to modify a user override when the clatest is not available to the student
