...
/**
 * Unit tests for usage of tags in clatestzes.
 *
 * @package    mod_clatest
...
/**
 * Class mod_clatest_tags_testcase
 * Class for tests related to usage of question tags in clatestzes.
 *
 * @copyright  2018 Shamim Rezaie <shamim@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_clatest_tags_testcase extends advanced_testcase {
    public function test_restore_random_question_by_tag() {
        ...
        get_file_packer('application/vnd.moodle.backup')->extract_to_pathname(
                __DIR__ . "/fixtures/random_by_tag_clatest.mbz", $backuppath);
        ...
        $clatest = array_values($modinfo->get_instances_of('clatest'))[0];
        $clatestobj = clatest::create($clatest->instance);
        ...
        $slottags = clatest_retrieve_slot_tags($question->slotid);
        $this->assertEquals(
                [
