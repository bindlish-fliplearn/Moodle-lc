...
/**
 * This page prints a summary of a homework attempt before it is submitted.
 *
...
$PAGE->set_url('/mod/homework/summary.php', array('attempt' => $attemptid));
...
$navbc = $attemptobj->get_navigation_panel($output, 'homework_attempt_nav_panel', -1);
$regions = $PAGE->blocks->get_regions();
$PAGE->blocks->add_fake_block($navbc, reset($regions));

$PAGE->navbar->add(get_string('summaryofattempt', 'homework'));
