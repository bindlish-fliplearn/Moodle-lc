...
$baseurl = new moodle_url('/mod/homework/reviewquestion.php',
...
$PAGE->set_title(get_string('reviewofquestion', 'homework', array(
...
if ($attemptobj->is_own_attempt()) {
    if (!$attemptobj->is_finished()) {
        echo $output->review_question_not_allowed($attemptobj, get_string('cannotreviewopen', 'homework'));
        die();
...
// Other attempts at the homework.
