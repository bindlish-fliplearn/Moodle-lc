...
/**
 * Strings for component 'homework', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['accessnoticesheader'] = 'You can preview this homework, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have homeworkzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the homework. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the homework. This means that different students are likely to get a different selection of questions, and when a homework allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any homework in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your homework over on the other side of this page.</p>';
...
$string['addquestionstohomework'] = 'Add questions to current homework';
...
$string['addrandomquestiontohomework'] = 'Add a random question to homework {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstohomework'] = 'Add selected questions to the homework';
$string['addselectedtohomework'] = 'Add selected to homework';
...
$string['attempterror'] = 'You are not allowed to attempt this homework at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid homework attempt ID';
$string['attempterrorcontentchange'] = 'This homework preview no longer exists. (When a homework is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This homework attempt no longer exists.';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attempthomeworknow'] = 'Attempt homework now';
$string['attempts'] = 'Attempts';
$string['attempts_help'] = 'The total number of attempts allowed (not the number of extra attempts).';
$string['attemptsallowed'] = 'Attempts allowed';
$string['attemptsdeleted'] = 'Homework attempts deleted';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during homework attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtohomework'] = 'Back to homework editing';
$string['basicideasofhomework'] = 'The basic ideas of homework-making';
...
* The homework will only start if the student has a JavaScript-enabled web-browser
* The homework appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this homework has been attempted. ({$a})';
...
$string['canredoquestions_desc'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire homework attempt and start another one. This option is mainly useful for practice homeworkzes.
...
$string['canredoquestions_help'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire homework attempt and start another one. This option is mainly useful for practice homeworkzes.
...
$string['closebeforeopen'] = 'Could not update the homework. You have specified a close date before the open date.';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the homework settings) or higher.';
...
$string['completionattemptsexhausted_help'] = 'Mark homework complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the homework.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the homework.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the homework.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a homework after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the homework.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new homework. You can also configure which homework settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the homework grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the homework page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the homework editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during homework attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the homework.';
$string['configrequiresubnet'] = 'Students can only attempt the homework from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a homework attempt or look at the homework reports.';
$string['configshowblocks'] = 'Show blocks during homework attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this homework, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for homeworkzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for homeworkzes in seconds. 0 mean no time limit.';
...
$string['continueattempthomework'] = 'Continue the last attempt';
...
$string['countdownfinished'] = 'The homework is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The homework will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to homework';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the homework.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the homework a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the homework a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/homework folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new homework attempt will contain the results of the previous attempt. This allows a homework to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editinghomework'] = 'Editing homework';
$string['editinghomework_help'] = 'When creating a homework, the main concepts are:

* The homework, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the homework and different students can get different questions';
$string['editinghomework_link'] = 'mod/homework/edit';
$string['editinghomeworkx'] = 'Editing homework: {$a}';
...
$string['edithomeworkquestions'] = 'Edit homework questions';
$string['emailconfirmbody'] = 'Hi {$a->username},

Thank you for submitting your answers to \'{$a->homeworkname}\' in course \'{$a->coursename}\' at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this homework at {$a->homeworkurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->homeworkname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->homeworkname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->homeworkname}\' ({$a->homeworkurl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->homeworkreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->homeworkname}. See {$a->homeworkreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->homeworkname}';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->homeworkname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->homeworkname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->homeworkname}';
$string['empty'] = 'Empty';
...
$string['eventattemptdeleted'] = 'Homework attempt deleted';
$string['eventattemptpreviewstarted'] = 'Homework attempt preview started';
$string['eventattemptreviewed'] = 'Homework attempt reviewed';
$string['eventattemptsummaryviewed'] = 'Homework attempt summary viewed';
$string['eventattemptviewed'] = 'Homework attempt viewed';
$string['eventeditpageviewed'] = 'Homework edit page viewed';
$string['eventoverridecreated'] = 'Homework override created';
$string['eventoverridedeleted'] = 'Homework override deleted';
$string['eventoverrideupdated'] = 'Homework override updated';
$string['eventquestionmanuallygraded'] = 'Question manually graded';
$string['eventhomeworkattemptabandoned'] = 'Homework attempt abandoned';
$string['eventhomeworkattempttimelimitexceeded'] = 'Homework attempt time limit exceeded';
$string['eventhomeworkattemptstarted'] = 'Homework attempt started';
$string['eventhomeworkattemptsubmitted'] = 'Homework attempt submitted';
$string['eventreportviewed'] = 'Homework report viewed';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the homework. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the homework when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the homework. You have to make a trade-off based on how much you trust the performance of your server during homeworkzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final homework grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'Homework grades deleted';
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->homeworkgrade}.';
$string['gradetopassnotset'] = 'This homework does not yet have a grade to pass set. It may be set in the Grade section of the homework settings.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this homework has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt homeworkzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a homework.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the homework';
$string['incorrect'] = 'Incorrect';
$string['indicator:cognitivedepth'] = 'Homework cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a Homework activity.';
$string['indicator:socialbreadth'] = 'Homework social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a Homework activity.';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new homework, provide this many blank overall feedback boxes. Once the homework has been created, the form shows the number of fields required for the number of feedbacks in the homework. The setting must be at least 1.';
...
$string['invalidhomeworkid'] = 'Invalid homework ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in homework';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->homework} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your homework attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own homework submissions';
$string['messageprovider:submission'] = 'Notification of homework submissions';
$string['max'] = 'Max';
...
$string['modulename_help'] = 'The homework activity enables a teacher to create homeworkzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the homework to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/homework/view';
$string['modulenameplural'] = 'Homeworkzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the homework in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the homework';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer homeworkzes it makes sense to stretch the homework over several pages by limiting the number of questions per page. When adding questions to the homework, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this homework';
...
$string['nogradewarning'] = 'This homework is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the homework settings.';
...
$string['noquestionsinhomework'] = 'There are no questions in this homework.';
...
$string['noreview'] = 'You are not allowed to review this homework';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this homework until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This homework is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the homework module. As a work around, set a time limit for the whole homework. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this homework';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this homework';
$string['numberabbr'] = '#';
...
$string['openafterclose'] = 'Could not update the homework. You have specified an open date after the close date.';
$string['openclosedatesupdated'] = 'Homework open and close dates updated';
...
$string['orderinghomework'] = 'Order and paging';
$string['orderinghomeworkx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a homework has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the homework before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their homework attempt before time expires. If the student is actively working on the homework at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/homework/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this homework to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->homework} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->homework} - Override';
$string['pageshort'] = 'P';
$string['page-mod-homework-x'] = 'Any homework module page';
$string['page-mod-homework-attempt'] = 'Attempt homework page';
$string['page-mod-homework-edit'] = 'Edit homework page';
$string['page-mod-homework-report'] = 'Any homework report page';
$string['page-mod-homework-review'] = 'Review homework attempt page';
$string['page-mod-homework-summary'] = 'Homework attempt summary page';
$string['page-mod-homework-view'] = 'Homework information page';
...
$string['popup'] = 'Show homework in a \'secure\' window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the homework in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this homework in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewhomework'] = 'Preview {$a}';
$string['previewhomeworknow'] = 'Preview homework now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The homework activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:homework'] = 'The homework activity makes use of homework reports.';
$string['privacy:metadata:homework_attempts'] = 'Details about each attempt on a homework.';
$string['privacy:metadata:homework_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:homework_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:homework_attempts:preview'] = 'Whether this is a preview of the homework.';
$string['privacy:metadata:homework_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:homework_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:homework_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:homework_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:homework_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:homework_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:homework_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:homework_grades'] = 'Details about the overall grade for this homework.';
$string['privacy:metadata:homework_grades:grade'] = 'The overall grade for this homework.';
$string['privacy:metadata:homework_grades:homework'] = 'The homework that was graded.';
$string['privacy:metadata:homework_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:homework_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:homework_overrides'] = 'Details about overrides for this homework';
$string['privacy:metadata:homework_overrides:homework'] = 'The homework with override information';
$string['privacy:metadata:homework_overrides:timeclose'] = 'The new close time for the homework.';
$string['privacy:metadata:homework_overrides:timelimit'] = 'The new time limit for the homework.';
$string['privacy:metadata:homework_overrides:timeopen'] = 'The new open time for the homework.';
$string['privacy:metadata:homework_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:homeworkaccess'] = 'The homework activity makes use of homework access rules.';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->homeworknames}<br />The question will not be deleted from these homeworkzes but only from the category list.';
...
$string['questionsinthishomework'] = 'Questions in this homework';
...
$string['homework:attempt'] = 'Attempt homeworkzes';
$string['homeworkavailable'] = 'The homework is available until: {$a}';
$string['homeworkclose'] = 'Close the homework';
$string['homeworkclosed'] = 'This homework closed on {$a}';
$string['homeworkcloses'] = 'Homework closes';
$string['homeworkeventcloses'] = '{$a} closes';
$string['homeworkcloseson'] = 'This homework will close at {$a}';
$string['homework:deleteattempts'] = 'Delete homework attempts';
$string['homework:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['homework:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['homework:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['homework:grade'] = 'Grade homeworkzes manually';
$string['homework:ignoretimelimits'] = 'Ignores time limit on homeworkzes';
$string['homeworkisclosed'] = 'This homework is closed';
$string['homeworkisopen'] = 'This homework is open';
$string['homeworkisclosedwillopen'] = 'Homework closed (opens {$a})';
$string['homeworkisopenwillclose'] = 'Homework open (closes {$a})';
$string['homework:manage'] = 'Manage homeworkzes';
$string['homework:manageoverrides'] = 'Manage homework overrides';
$string['homeworknavigation'] = 'Homework navigation';
$string['homeworkopen'] = 'Open the homework';
$string['homeworkeventopens'] = '{$a} opens';
$string['homeworkopenclose'] = 'Open and close dates';
$string['homeworkopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['homeworkopenclose_link'] = 'mod/homework/timing';
$string['homeworkopened'] = 'This homework is open.';
$string['homeworkopenedon'] = 'This homework opened at {$a}';
$string['homeworkopens'] = 'Homework opens';
$string['homeworkopenwillclose'] = 'This homework is open, will close on {$a} at';
$string['homeworkordernotrandom'] = 'Order of homework not shuffled';
$string['homeworkorderrandom'] = '* Order of homework is shuffled';
$string['homework:preview'] = 'Preview homeworkzes';
$string['homework:regrade'] = 'Regrade homework attempts';
$string['homework:reviewmyattempts'] = 'Review your own attempts';
$string['homeworksettings'] = 'Homework settings';
$string['homework:view'] = 'View homework information';
$string['homework:viewreports'] = 'View homework reports';
$string['homeworktimer'] = 'Homework Timer';
$string['homeworkwillopen'] = 'This homework will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole homework to be graded.  Are you sure you want to continue?';
$string['reattempthomework'] = 'Re-attempt homework';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this homework';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradinghomework'] = 'Regrading homework "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallhomeworkattempts'] = 'Delete all homework attempts';
...
$string['reportusersall'] = 'all users who have attempted the homework';
$string['reportuserswith'] = 'enrolled users who have attempted the homework';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the homework';
$string['reportuserswithout'] = 'enrolled users who have not attempted the homework';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the homework.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Homework access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) homework, to ensure that only people in a certain location can access the homework.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to homework defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after homework is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while homework is open';
$string['reviewclosed'] = 'After the homework is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->homework} by {$a->user}';
$string['reviewopen'] = 'Later, while the homework is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a homework attempt or look at the homework reports.
...
**Later, while the homework is still open** settings apply after this, and before the homework close date.

**After the homework is closed** settings apply after the homework close date has passed. If the homework does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current homework attempt.';
...
$string['savehomework'] = 'Save this whole homework';
...
$string['search:activity'] = 'Homework - activity information';
...
$string['showblocks'] = 'Show blocks during homework attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during homework attempts';
...
$string['shufflequestions_help'] = 'If you turn this on, then every time the homework is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the homework, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonhomework'] = 'Specified question is not on the specified homework';
...
$string['subneterror'] = 'Sorry, this homework has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this homework.';
$string['subnetnotice'] = 'This homework has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_homework'] = 'Report';
$string['subplugintype_homework_plural'] = 'Reports';
$string['subplugintype_homeworkaccess'] = 'Access rule';
$string['subplugintype_homeworkaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the homework.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the homework since you have not passed the time delay before attempting another homework';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial homework page and a countdown timer is displayed in the homework navigation block.';
$string['timelimit_link'] = 'mod/homework/timing';
$string['timelimitexeeded'] = 'Sorry! Homework time limit exceeded!';
...
$string['updatesettings'] = 'Update homework settings';
$string['updatehomeworkslotswithrandomxofy'] = 'Updating homework slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the homework module will perform an extensive change of the homework tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradinghomeworkattempts'] = 'Upgrading homework attempts: homework {$a->done}/{$a->outof} (Homework id {$a->info})';
$string['upgradingveryoldhomeworkattempts'] = 'Upgrading very old homework attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this homework';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} homework attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this homework';
$string['yourfinalgradeis'] = 'Your final grade for this homework is {$a}.';
