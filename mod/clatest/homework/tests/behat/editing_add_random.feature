@mod @mod_homework @javascript
Feature: Adding random questions to a homework based on category and tags
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | homework       | Quiz 1 | Quiz 1 for testing the Add random question form | C1     | homework1    |
