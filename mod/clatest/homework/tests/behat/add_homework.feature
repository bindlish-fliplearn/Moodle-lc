@mod @mod_homework
Feature: Add a homework
  In order to evaluate students
  As a teacher
  I need to create a homework
  ...
  Background:
    ...
    And I add a "True/False" question to the "Test homework name" homework with:
  ...
  @javascript
  Scenario: Add and configure small homework and perform an attempt as a student with Javascript enabled
  ...
  Scenario: Add and configure small homework and perform an attempt as a student with Javascript disabled
