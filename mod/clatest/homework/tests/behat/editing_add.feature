@mod @mod_homework
Feature: Edit homework page - adding things
  In order to build the homework I want my students to attempt
  As a teacher
  I need to be able to add questions to the homework.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | homework       | Quiz 1 | Quiz 1 for testing the Add menu | C1     | homework1    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "Quiz 1"
    And I navigate to "Edit homework" in current page administration
    Then I should see "Editing homework: Quiz 1"

  @javascript
  Scenario: Add some new question to the homework using '+ a new question' options of the 'Add' menu.
    And I open the "last" add to homework menu
    ...
    Then I should see "Editing homework: Quiz 1"
    And I should see "Essay 01 new" on homework page "1"

    And I open the "Page 1" add to homework menu
    And I follow "a new question"
    And I set the field "item_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    Then I should see "Editing homework: Quiz 1"
    And I should see "Essay 01 new" on homework page "1"
    And I should see "Essay 02 new" on homework page "1"
    ...
    And I should see "Essay 01 new" on homework page "1"
    And I should see "Essay 02 new" on homework page "1"
    And I should see "Essay 03 new" on homework page "1"
    ...
    And I should see "Essay 02 new" on homework page "1"
    And I should see "Essay 03 new" on homework page "1"
    And I should see "Essay 04 new" on homework page "1"
    ...
    And I should see "Essay 01 new" on homework page "1"
    And I should see "Essay 02 new" on homework page "1"
    And I should see "Essay 03 new" on homework page "2"
    And I should see "Essay 04 new" on homework page "2"

    # Add a question to page 2.
    When I open the "Page 2" add to homework menu
    ...
    And I should see "Essay 03 new" on homework page "2"
    And I should see "Essay 04 new" on homework page "2"
    And I should see "Essay for page 2" on homework page "2"

  @javascript
  Scenario: Add questions from question bank to the homework. In order to be able to
      add questions from question bank to the homework, first we create some new questions
    ...
    Then the "Add selected questions to the homework" "button" should be disabled
    And I click on "Essay 03" "checkbox"
    Then the "Add selected questions to the homework" "button" should be enabled
    And I click on "Add to homework" "link" in the "Essay 03" "table_row"
    Then I should see "Editing homework: Quiz 1"
    And I should see "Essay 03" on homework page "1"

    # Add Essay 01 from question bank.
    And I open the "Page 1" add to homework menu
    And I follow "from question bank"
    And I click on "Add to homework" "link" in the "Essay 01" "table_row"
    Then I should see "Editing homework: Quiz 1"
    And I should see "Essay 03" on homework page "1"
    And I should see "Essay 01" on homework page "1"
    ...
    And I should see "Select a category"
    And I set the field "Select a category" to "Subcat 1"
    And I click on "Add to homework" "link" in the "Essay 02" "table_row"
    Then I should see "Editing homework: Quiz 1"
    And I should see "Essay 03" on homework page "1"
    And I should see "Essay 01" on homework page "1"
    And I should see "Essay 02" on homework page "1"
    ...
    And I should see "Essay 01" on homework page "1"
    And I should see "Essay 02" on homework page "1"
    And I should see "Random" on homework page "1"
    ...
    When I press "Go"
    And I should see "Essay 03" on homework page "1"
    And I should see "Essay 01" on homework page "2"
    And I should see "Essay 02" on homework page "3"
    And I should see "Random" on homework page "4"

    # Add a random question to page 4.
    And I open the "Page 4" add to homework menu
    And I choose "a new question" in the open action menu
    And I set the field "item_qtype_essay" to "1"
    And I press "submitbutton"
    Then I should see "Adding an Essay question"
    ...
    And I should see "Essay 02" on homework page "3"
    And I should see "Random" on homework page "4"
    And I should see "Essay for page 4" on homework page "4"
