 ...
 *
 * @module     mod_homework/modal_add_random_question
...
function(
    ...
    ModalAddRandomQuestion.TYPE = 'mod_homework-homework-add-random-question';
    ...
    if (!registered) {
        ModalRegistry.register(
            ...
            'mod_homework/modal_add_random_question'
        );
