...
/**
 * The homeworkaccess_user_provider interface provides the expected interface for all 'homeworkaccess' homeworkaccesss.
 *
...
interface homeworkaccess_user_provider extends \core_privacy\local\request\plugin\subplugin_provider {
