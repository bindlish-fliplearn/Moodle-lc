...
/**
 * The mod_homework attempt started event.
 *
...
/**
 * The mod_homework attempt started event class.
 *
...
class attempt_started extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has started the attempt with id '$this->objectid' for the " .
            "homework with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventhomeworkattemptstarted', 'mod_homework');
    }
    ...
    static public function get_legacy_eventname() {
        return 'homework_attempt_started';
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'homework', 'attempt', 'review.php?attempt=' . $this->objectid,
            $attempt->homework, $this->contextinstanceid);
    }
