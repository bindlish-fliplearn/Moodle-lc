YUI.add('moodle-mod_homework-repaginate', function (Y, NAME) {
...
/**
 * Repaginate functionality for a popup in homework editing page.
 *
...
M.mod_homework.repaginate = M.mod_homework.repaginate || {};
M.mod_homework.repaginate.init = function() {
    return new POPUP();
};
