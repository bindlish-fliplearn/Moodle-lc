YUI.add('moodle-mod_homework-homeworkbase', function (Y, NAME) {

/**
 * The homeworkbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_homework-homeworkbase
 */
var QUIZBASENAME = 'mod_homework-homeworkbase';
...
M.mod_homework.homeworkbase = M.mod_homework.homeworkbase || new QUIZBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_homework.edit = M.mod_homework.edit || {};
 ...
 */
M.mod_homework.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_homework.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
