...
/**
 * Base class for rules that restrict the ability to attempt a flipquiz.
 *
...
/**
 * A base class that defines the interface for the various flipquiz access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class flipquiz_access_rule_base {
    /** @var stdClass the flipquiz settings. */
    protected $flipquiz;
    /** @var flipquiz the flipquiz object. */
    protected $flipquizobj;
    /** @var int the time to use as 'now'. */
    protected $timenow;

    /**
     * Create an instance of this rule for a particular flipquiz.
     * @param flipquiz $flipquizobj information about the flipquiz in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($flipquizobj, $timenow) {
        $this->flipquizobj = $flipquizobj;
        $this->flipquiz = $flipquizobj->get_flipquiz();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given flipquiz, otherwise return null.
     * @param flipquiz $flipquizobj information about the flipquiz in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/flipquiz:ignoretimelimits capability.
     * @return flipquiz_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_flipquiz_preflight_check_form $flipquizform the form being built.
    ...
    /**
     * This is called when the current attempt at the flipquiz is finished. This is
    ...
    /**
     * Information, such as might be shown on the flipquiz view page, relating to this restriction.
     ...
     * this flipquiz, then return true. This is used so we can know whether to display a
    ...
    /**
     * Add any fields that this rule requires to the flipquiz settings form. This
     * method is called from {@link mod_flipquiz_mod_form::definition()}, while the
    ...
    /**
     * @return array key => lang string any choices to add to the flipquiz Browser
    ...
    /**
     * Save any submitted settings when the flipquiz settings form is submitted. This
     * is called from {@link flipquiz_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the flipquiz is deleted. This is called
     * from {@link flipquiz_delete_instance()} in lib.php.
     ...
     * here is probalby to read the code of {@link flipquiz_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $flipquizid the id of the flipquiz we are loading settings for. This
     *     can also be accessed as flipquiz.id in the SQL. (flipquiz is a table alisas for {flipquiz}.)
     ...
     */
    public static function get_settings_sql($flipquizid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($flipquizid) {
        return array();
    }
}
