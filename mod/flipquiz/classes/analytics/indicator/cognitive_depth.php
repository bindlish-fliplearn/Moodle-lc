...
/**
 * Cognitive depth indicator - flipquiz.
 *
...
namespace mod_flipquiz\analytics\indicator;
...
class cognitive_depth extends activity_base {
    ...
    public static function get_name() : \lang_string {
        return new \lang_string('indicator:cognitivedepth', 'mod_flipquiz');
    }
    ...
    protected function feedback_submitted_events() {
        return array('\mod_flipquiz\event\attempt_submitted');
    }
