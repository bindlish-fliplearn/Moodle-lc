...
/**
 * The mod_flipquiz attempt started event.
 *
...
/**
 * The mod_flipquiz attempt started event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int flipquizid: (optional) the id of the flipquiz.
 * }
 *
 * @package    mod_flipquiz
 * @since      Moodle 2.6
...
class attempt_started extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has started the attempt with id '$this->objectid' for the " .
            "flipquiz with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventflipquizattemptstarted', 'mod_flipquiz');
    }
    ...
    static public function get_legacy_eventname() {
        return 'flipquiz_attempt_started';
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'flipquiz', 'attempt', 'review.php?attempt=' . $this->objectid,
            $attempt->flipquiz, $this->contextinstanceid);
    }
