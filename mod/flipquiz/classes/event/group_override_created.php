...
/**
 * The mod_flipquiz group override created event.
 *
...
/**
 * The mod_flipquiz group override created event class.
 *
...
class group_override_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverridecreated', 'mod_flipquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the override with id '$this->objectid' for the flipquiz with " .
