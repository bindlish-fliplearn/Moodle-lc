...
/**
 * The mod_flipquiz attempt reviewed event.
 *
...
/**
 * The mod_flipquiz attempt reviewed event class.
 *
...
class attempt_reviewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptreviewed', 'mod_flipquiz');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'flipquiz', 'review', 'review.php?attempt=' . $this->objectid,
