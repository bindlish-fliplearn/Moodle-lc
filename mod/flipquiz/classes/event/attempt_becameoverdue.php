...
/**
 * The mod_flipquiz attempt became overdue event.
 *
...
/**
 * The mod_flipquiz attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The flipquiz attempt with id '$this->objectid' belonging to the flipquiz with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventflipquizattempttimelimitexceeded', 'mod_flipquiz');
    }
    ...
    static public function get_legacy_eventname() {
        return 'flipquiz_attempt_overdue';
    }
