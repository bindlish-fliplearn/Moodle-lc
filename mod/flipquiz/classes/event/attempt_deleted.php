...
/**
 * The mod_flipquiz attempt deleted event.
 *
...
/**
 * The mod_flipquiz attempt deleted event class.
 *
...
class attempt_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptdeleted', 'mod_flipquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the attempt with id '$this->objectid' belonging to the flipquiz " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'flipquiz', 'delete attempt', 'report.php?id=' . $this->contextinstanceid,
