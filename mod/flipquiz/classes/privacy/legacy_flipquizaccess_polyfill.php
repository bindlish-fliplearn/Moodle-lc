 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
trait legacy_flipquizaccess_polyfill {
    ...
    public static function export_flipquizaccess_user_data(\flipquiz $flipquiz, \stdClass $user) : \stdClass {
        return static::_export_flipquizaccess_user_data($flipquiz, $user);
    }
    ...
    public static function delete_flipquizaccess_data_for_all_users_in_context(\flipquiz $flipquiz) {
        static::_delete_flipquizaccess_data_for_all_users_in_context($flipquiz);
    }
    ...
    public static function delete_flipquizaccess_data_for_user(\flipquiz $flipquiz, \stdClass $user) {
        static::_delete_flipquizaccess_data_for_user($flipquiz, $user);
    }
     ...
     */
    public static function delete_flipquizaccess_data_for_users(approved_userlist $userlist) {
        static::_delete_flipquizaccess_data_for_users($userlist);
    }
}
