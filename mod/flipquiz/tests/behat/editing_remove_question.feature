@mod @mod_flipquiz
Feature: Edit flipquiz page - remove questions
  ...
  Scenario: Delete questions by clicking on the delete icon.
    ...
    And I should see "This flipquiz is open"

    # Delete last question in last page. Page contains multiple questions
    When I delete "Question C" in the flipquiz by clicking the delete icon
    Then I should see "Question A" on flipquiz page "1"
    And I should see "Question B" on flipquiz page "1"
    And I should not see "Question C" on flipquiz page "2"
    ...
    Then I should see "Question B" on flipquiz page "2"
    And the "Remove" page break icon after question "Question A" should exist
    And I delete "Question A" in the flipquiz by clicking the delete icon
    Then I should see "Question B" on flipquiz page "1"
    And I should not see "Page 2"
    And I should not see "Question A" on flipquiz page "2"
  ...
  Scenario: Cannot delete the last question in a section.
    ...
    And flipquiz "Quiz 1" contains the following sections:
      ...
      | Heading 1 | 1         | 1       |
      | Heading 2 | 2         | 1       |
    When I navigate to "Edit flipquiz" in current page administration
  ...
  @javascript
  Scenario: Can delete the last question in a flipquiz.
    Given the following "questions" exist:
      | questioncategory | qtype     | name       | questiontext        |
      | Test questions   | truefalse | Question A | This is question 01 |
    And flipquiz "Quiz 1" contains the following questions:
