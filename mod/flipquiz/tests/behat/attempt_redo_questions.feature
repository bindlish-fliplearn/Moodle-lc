@mod @mod_flipquiz
Feature: Allow students to redo questions in a practice flipquiz, without starting a whole new attempt
  In order to practice particular skills I am struggling with
  As a student
  I need to be able to redo each question in a flipquiz as often as necessary without starting a whole new attempt, if my teacher allows it.
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | flipquiz       | Quiz 1 | Quiz 1 description | C1     | flipquiz1    | immediatefeedback  | 1                |
  ...
  Scenario: Teachers reviewing can see all the qestions attempted in a slot
    ...
    And I follow "TF1"
    And "False" row "Frequency" column of "flipquizresponseanalysis" table should contain "100.00%"
    And "True" row "Frequency" column of "flipquizresponseanalysis" table should contain "0.00%"
    And "[No response]" row "Frequency" column of "flipquizresponseanalysis" table should contain "100.00%"
