@mod @mod_flipquiz
Feature: Edit flipquiz marks with attempts
  In order to create a flipquiz that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit flipquiz page (even after the flipquiz has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | flipquiz       | Quiz 1 | C1     | flipquiz1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add a "True/False" question to the "Quiz 1" flipquiz with:
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the flipquiz settings say it should be.
