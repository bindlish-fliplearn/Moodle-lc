@mod @mod_flipquiz @javascript
Feature: Quiz user override
  In order to grant a student special access to a flipquiz
  As a teacher
  ...
  Scenario: Being able to modify a user override when the flipquiz is not available to the student
