@mod @mod_flipquiz
Feature: Set a flipquiz to be marked complete when the student uses all attempts allowed
  In order to ensure a student has learned the material before being marked complete
  As a teacher
  I need to set a flipquiz to complete when the student receives a passing grade, or completed_fail if they use all attempts without passing
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | flipquiz       | Test flipquiz name | C1     | flipquiz1    | 2        | 5.00      | 2          | 1                           |
  ...
  Scenario: student1 uses up both attempts without passing
    ...
    And the "Test flipquiz name" "flipquiz" activity with "auto" completion should be marked as not complete
    And I follow "Test flipquiz name"
    And I press "Re-attempt flipquiz"
    And I set the field "False" to "1"
    And I press "Finish attempt ..."
    And I press "Submit all and finish"
    And I am on "Course 1" course homepage
