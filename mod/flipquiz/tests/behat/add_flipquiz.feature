@mod @mod_flipquiz
Feature: Add a flipquiz
  In order to evaluate students
  As a teacher
  I need to create a flipquiz
  ...
  Background:
    ...
    And I add a "Quiz" to section "1" and I fill the form with:
      | Name        | Test flipquiz name        |
      | Description | Test flipquiz description |
    And I add a "True/False" question to the "Test flipquiz name" flipquiz with:
  ...
  @javascript
  Scenario: Add and configure small flipquiz and perform an attempt as a student with Javascript enabled
  ...
  Scenario: Add and configure small flipquiz and perform an attempt as a student with Javascript disabled
