 ...
 */
class mod_flipquiz_generator extends testing_module_generator {
    ...
    public function create_instance($record = null, array $options = null) {
        ...
        $defaultflipquizsettings = array(
            'timeopen'               => 0,
            'timeclose'              => 0,
            'preferredbehaviour'     => 'deferredfeedback',
            'attempts'               => 0,
            'attemptonlast'          => 0,
            'grademethod'            => FLIPQUIZ_GRADEHIGHEST,
            'decimalpoints'          => 2,
            ...
            'showuserpicture'        => 0,
            'showblocks'             => 0,
            'navmethod'              => FLIPQUIZ_NAVMETHOD_FREE,
        );

        foreach ($defaultflipquizsettings as $name => $value) {
