...
require_once($CFG->dirroot . '/mod/flipquiz/report/overview/flip_report.php');
...
$url = new moodle_url('/mod/flipquiz/flip_report.php', array('id' => $cm->id));
if ($mode !== '') {
    $url->param('mode', $mode);
}
$PAGE->set_url($url);
...
if (!is_readable("report/$mode/flip_report.php")) {
...
$report = new flipquiz_filp_overview_report();
