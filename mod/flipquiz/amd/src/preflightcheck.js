 ...
 *
 * This is also responsible for opening the pop-up window, if the flipquiz requires to be in one.
 *
 * @module    mod_flipquiz/preflightcheck
...
define(['jquery', 'core/yui'], function($, Y) {
    ...
    /**
     * @alias module:mod_flipquiz/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the flipquiz should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_flipquiz_preflight_popup']
                    });
        ...
        /**
         * Event handler for the flipquiz start attempt button.
