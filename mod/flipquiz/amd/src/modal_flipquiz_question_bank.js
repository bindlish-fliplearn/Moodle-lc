 ...
 *
 * @module     mod_flipquiz/modal_flipquiz_question_bank
...
function(
    ...
    var SELECTORS = {
        ADD_TO_FLIPQUIZ_CONTAINER: 'td.addtoflipquizaction',
        ANCHOR: 'a[href]',
    ...
    ModalQuizQuestionBank.TYPE = 'mod_flipquiz-flipquiz-question-bank';
     ...
     * when the user clicks the add to flipquiz link.
     *
     ...
     *      - The flipquiz category select box
    ...
    ModalQuizQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to flipquiz link.
            if (anchorElement.closest(SELECTORS.ADD_TO_FLIPQUIZ_CONTAINER).length) {
