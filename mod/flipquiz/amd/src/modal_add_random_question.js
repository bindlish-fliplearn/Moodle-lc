 ...
 *
 * @module     mod_flipquiz/modal_add_random_question
...
function(
    ...
    ModalAddRandomQuestion.TYPE = 'mod_flipquiz-flipquiz-add-random-question';
    ...
    if (!registered) {
        ModalRegistry.register(
            ...
            'mod_flipquiz/modal_add_random_question'
        );
