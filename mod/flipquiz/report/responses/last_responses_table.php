...
/**
 * This file defines the flipquiz responses table for showing last try at question.
 *
...
/**
 * This is a table subclass for displaying the flipquiz responses report.
 *
 * @copyright 2008 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class flipquiz_last_responses_table extends flipquiz_attempts_report_table {
     ...
     * @param flipquiz_responses_options $options
     * @param \core\dml\sql_join $groupstudentsjoins
     * @param \core\dml\sql_join $studentsjoins
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($flipquiz, $context, $qmsubselect, flipquiz_responses_options $options,
            \core\dml\sql_join $groupstudentsjoins, \core\dml\sql_join $studentsjoins, $questions, $reporturl) {
        parent::__construct('mod-flipquiz-report-responses-report', $flipquiz, $context,
    ...
    public function col_sumgrades($attempt) {
        ...
        $gradehtml = '<a href="review.php?q=' . $this->flipquiz->id . '&amp;attempt=' .
