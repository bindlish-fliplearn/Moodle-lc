 ...
 */
function xmldb_flipquiz_overview_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2018061800) {
        ...
        // Define key questionusageid-slot (foreign) to be dropped form flipquiz_overview_regrades.
        $table = new xmldb_table('flipquiz_overview_regrades');
        ...
        upgrade_plugin_savepoint(true, 2018061800, 'flipquiz', 'overview');
    }

    if ($oldversion < 2018061801) {

        // Define key questionusageid-slot (foreign) to be added to flipquiz_overview_regrades.
        $table = new xmldb_table('flipquiz_overview_regrades');
        $key = new xmldb_key('questionusageid-slot', XMLDB_KEY_FOREIGN, array('questionusageid', 'slot'), 'question_attempts', array('questionusageid', 'slot'));
        ...
        // Overview savepoint reached.
        upgrade_plugin_savepoint(true, 2018061801, 'flipquiz', 'overview');
    }
