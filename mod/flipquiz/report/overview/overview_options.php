...
/**
 * Class to store the options for a {@link flipquiz_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class flipquiz_overview_options extends mod_flipquiz_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('flipquiz_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (flipquiz_has_grades($this->flipquiz)) {
            set_user_preference('flipquiz_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/flipquiz:regrade', 'mod/flipquiz:deleteattempts'), context_module::instance($this->cm->id))
