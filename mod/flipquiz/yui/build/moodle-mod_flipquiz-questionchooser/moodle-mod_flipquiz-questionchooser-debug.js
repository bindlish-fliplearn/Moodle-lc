YUI.add('moodle-mod_flipquiz-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_flipquiz-questionchooser'
});

M.mod_flipquiz = M.mod_flipquiz || {};
M.mod_flipquiz.init_questionchooser = function() {
    M.mod_flipquiz.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_flipquiz.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_flipquiz-util", "querystring-parse"]});
