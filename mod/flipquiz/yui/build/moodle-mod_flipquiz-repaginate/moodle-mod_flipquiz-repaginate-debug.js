YUI.add('moodle-mod_flipquiz-repaginate', function (Y, NAME) {
...
/**
 * Repaginate functionality for a popup in flipquiz editing page.
 *
...
M.mod_flipquiz.repaginate = M.mod_flipquiz.repaginate || {};
M.mod_flipquiz.repaginate.init = function() {
    return new POPUP();
};
