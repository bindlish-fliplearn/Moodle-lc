...
/**
 * This page deals with processing responses during an attempt at a flipquiz.
 *
...
if ($attemptobj->is_finished()) {
    throw new moodle_flipquiz_exception($attemptobj->get_flipquizobj(),
...
if ($status == flipquiz_attempt::OVERDUE) {
    redirect($attemptobj->summary_url());
} else if ($status == flipquiz_attempt::IN_PROGRESS) {
    redirect($nexturl);
} else {
