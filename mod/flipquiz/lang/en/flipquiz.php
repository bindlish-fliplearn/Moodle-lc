...
/**
 * Strings for component 'flipquiz', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['accessnoticesheader'] = 'You can preview this flipquiz, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have flipquizzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the flipquiz. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the flipquiz. This means that different students are likely to get a different selection of questions, and when a flipquiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any flipquiz in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your flipquiz over on the other side of this page.</p>';
...
$string['addquestionstoflipquiz'] = 'Add questions to current flipquiz';
...
$string['addrandomquestiontoflipquiz'] = 'Add a random question to flipquiz {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstoflipquiz'] = 'Add selected questions to the flipquiz';
$string['addselectedtoflipquiz'] = 'Add selected to flipquiz';
$string['addtoflipquiz'] = 'Add to flipquiz';
...
$string['attempterror'] = 'You are not allowed to attempt this flipquiz at this time because: {$a}';
$string['attempterrorinvalid'] = 'Invalid flipquiz attempt ID';
$string['attempterrorcontentchange'] = 'This flipquiz preview no longer exists. (When a flipquiz is edited, any in-progress previews are automatically deleted.)';
$string['attempterrorcontentchangeforuser'] = 'This flipquiz attempt no longer exists.';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptflipquiznow'] = 'Attempt flipquiz now';
...
$string['autosaveperiod_desc'] = 'Responses can be saved automatically during flipquiz attempts. The responses are saved whenever one is changed, and then after this delay. There is a trade-off: a shorter delay increases the server load, but reduces the chance that students lose their work. If you are going to make this delay much shorter, you should change the value gradually and monitor the server load. If the load gets too high, make the delay longer again. Setting the delay to 0 turns off auto-saving.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtoflipquiz'] = 'Back to flipquiz editing';
$string['basicideasofflipquiz'] = 'The basic ideas of flipquiz-making';
...
* The flipquiz will only start if the student has a JavaScript-enabled web-browser
* The flipquiz appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this flipquiz has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the flipquiz';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this flipquiz. The flipquiz is set to be graded out of {$a->grade}, but none of the questions in the flipquiz have a grade. This can be fixed on the \'Edit flipquiz\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this flipquiz. The flipquiz definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this flipquiz. The flipquiz has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire flipquiz attempt and start another one. This option is mainly useful for practice flipquizzes.
...
$string['canredoquestions_help'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire flipquiz attempt and start another one. This option is mainly useful for practice flipquizzes.
...
$string['closebeforeopen'] = 'Could not update the flipquiz. You have specified a close date before the open date.';
...
$string['completionpass_help'] = 'If enabled, this activity is considered complete when the student receives a pass grade (as specified in the Grade section of the flipquiz settings) or higher.';
...
$string['completionattemptsexhausted_help'] = 'Mark flipquiz complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the flipquiz.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the flipquiz.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the flipquiz.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a flipquiz after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the flipquiz.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new flipquiz. You can also configure which flipquiz settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the flipquiz grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the flipquiz page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the flipquiz editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during flipquiz attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the flipquiz.';
$string['configrequiresubnet'] = 'Students can only attempt the flipquiz from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a flipquiz attempt or look at the flipquiz reports.';
$string['configshowblocks'] = 'Show blocks during flipquiz attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this flipquiz, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for flipquizzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for flipquizzes in seconds. 0 mean no time limit.';
...
$string['continueattemptflipquiz'] = 'Continue the last attempt';
...
$string['countdownfinished'] = 'The flipquiz is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The flipquiz will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to flipquiz';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the flipquiz.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the flipquiz a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the flipquiz a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/flipquiz folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new flipquiz attempt will contain the results of the previous attempt. This allows a flipquiz to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingflipquiz'] = 'Editing flipquiz';
$string['editingflipquiz_help'] = 'When creating a flipquiz, the main concepts are:

* The flipquiz, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the flipquiz and different students can get different questions';
$string['editingflipquiz_link'] = 'mod/flipquiz/edit';
$string['editingflipquizx'] = 'Editing flipquiz: {$a}';
...
$string['editflipquiz'] = 'Edit flipquiz';
$string['editflipquizquestions'] = 'Edit flipquiz questions';
$string['emailconfirmbody'] = 'Hi {$a->username},

Thank you for submitting your answers to \'{$a->flipquizname}\' in course \'{$a->coursename}\' at {$a->submissiontime}.

This message confirms that your answers have been saved.

You can access this flipquiz at {$a->flipquizurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->flipquizname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->flipquizname}';
$string['emailnotifybody'] = 'Hi {$a->username},

{$a->studentname} has completed \'{$a->flipquizname}\' ({$a->flipquizurl}) in course \'{$a->coursename}\'.

You can review this attempt at {$a->flipquizreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->flipquizname}. See {$a->flipquizreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->flipquizname}';
$string['emailoverduebody'] = 'Hi {$a->studentname},

You started an attempt at \'{$a->flipquizname}\' in course \'{$a->coursename}\', but you never submitted it. It should have been submitted by {$a->attemptduedate}.
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->flipquizname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->flipquizname}';
$string['empty'] = 'Empty';
...
$string['eventflipquizattemptabandoned'] = 'Quiz attempt abandoned';
$string['eventflipquizattempttimelimitexceeded'] = 'Quiz attempt time limit exceeded';
$string['eventflipquizattemptstarted'] = 'Quiz attempt started';
$string['eventflipquizattemptsubmitted'] = 'Quiz attempt submitted';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the flipquiz. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the flipquiz when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the flipquiz. You have to make a trade-off based on how much you trust the performance of your server during flipquizzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final flipquiz grade:
...
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->flipquizgrade}.';
$string['gradetopassnotset'] = 'This flipquiz does not yet have a grade to pass set. It may be set in the Grade section of the flipquiz settings.';
$string['gradetopassmustbeset'] = 'Grade to pass cannot be zero as this flipquiz has its completion method set to require passing grade. Please set a non-zero value.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt flipquizzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a flipquiz.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the flipquiz';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new flipquiz, provide this many blank overall feedback boxes. Once the flipquiz has been created, the form shows the number of fields required for the number of feedbacks in the flipquiz. The setting must be at least 1.';
...
$string['invalidflipquizid'] = 'Invalid flipquiz ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in flipquiz';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->flipquiz} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your flipquiz attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own flipquiz submissions';
$string['messageprovider:submission'] = 'Notification of flipquiz submissions';
$string['max'] = 'Max';
...
* For self-assessment';
$string['modulename_link'] = 'mod/flipquiz/view';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the flipquiz in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the flipquiz';
$string['newcategory'] = 'New category';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer flipquizzes it makes sense to stretch the flipquiz over several pages by limiting the number of questions per page. When adding questions to the flipquiz, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
...
$string['noattempts'] = 'No attempts have been made on this flipquiz';
...
$string['nogradewarning'] = 'This flipquiz is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the flipquiz settings.';
...
$string['noquestionsinflipquiz'] = 'There are no questions in this flipquiz.';
...
$string['noreview'] = 'You are not allowed to review this flipquiz';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this flipquiz until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This flipquiz is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the flipquiz module. As a work around, set a time limit for the whole flipquiz. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this flipquiz';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this flipquiz';
$string['numberabbr'] = '#';
...
$string['openafterclose'] = 'Could not update the flipquiz. You have specified an open date after the close date.';
...
$string['orderingflipquiz'] = 'Order and paging';
$string['orderingflipquizx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a flipquiz has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the flipquiz before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their flipquiz attempt before time expires. If the student is actively working on the flipquiz at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/flipquiz/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this flipquiz to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->flipquiz} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->flipquiz} - Override';
$string['pageshort'] = 'P';
$string['page-mod-flipquiz-x'] = 'Any flipquiz module page';
$string['page-mod-flipquiz-attempt'] = 'Attempt flipquiz page';
$string['page-mod-flipquiz-edit'] = 'Edit flipquiz page';
$string['page-mod-flipquiz-report'] = 'Any flipquiz report page';
$string['page-mod-flipquiz-review'] = 'Review flipquiz attempt page';
$string['page-mod-flipquiz-summary'] = 'Quiz attempt summary page';
$string['page-mod-flipquiz-view'] = 'Quiz information page';
...
$string['previewflipquiz'] = 'Preview {$a}';
$string['previewflipquiznow'] = 'Preview flipquiz now';
$string['previous'] = 'Previous state';
$string['privacy:metadata:core_question'] = 'The flipquiz activity stores question usage information in the core_question subsystem.';
$string['privacy:metadata:flipquiz'] = 'The flipquiz activity makes use of flipquiz reports.';
$string['privacy:metadata:flipquiz_attempts'] = 'Details about each attempt on a flipquiz.';
$string['privacy:metadata:flipquiz_attempts:attempt'] = 'The attempt number.';
$string['privacy:metadata:flipquiz_attempts:currentpage'] = 'The current page that the user is on.';
$string['privacy:metadata:flipquiz_attempts:preview'] = 'Whether this is a preview of the flipquiz.';
$string['privacy:metadata:flipquiz_attempts:state'] = 'The current state of the attempt.';
$string['privacy:metadata:flipquiz_attempts:sumgrades'] = 'The sum of grades in the attempt.';
$string['privacy:metadata:flipquiz_attempts:timecheckstate'] = 'The time that the state was checked.';
$string['privacy:metadata:flipquiz_attempts:timefinish'] = 'The time that the attempt was completed.';
$string['privacy:metadata:flipquiz_attempts:timemodified'] = 'The time that the attempt was updated.';
$string['privacy:metadata:flipquiz_attempts:timemodifiedoffline'] = 'The time that the attempt was updated via an offline update.';
$string['privacy:metadata:flipquiz_attempts:timestart'] = 'The time that the attempt was started.';
$string['privacy:metadata:flipquiz_grades'] = 'Details about the overall grade for this flipquiz.';
$string['privacy:metadata:flipquiz_grades:grade'] = 'The overall grade for this flipquiz.';
$string['privacy:metadata:flipquiz_grades:flipquiz'] = 'The flipquiz that was graded.';
$string['privacy:metadata:flipquiz_grades:timemodified'] = 'The time that the grade was modified.';
$string['privacy:metadata:flipquiz_grades:userid'] = 'The user who was graded.';
$string['privacy:metadata:flipquiz_overrides'] = 'Details about overrides for this flipquiz';
$string['privacy:metadata:flipquiz_overrides:flipquiz'] = 'The flipquiz with override information';
$string['privacy:metadata:flipquiz_overrides:timeclose'] = 'The new close time for the flipquiz.';
$string['privacy:metadata:flipquiz_overrides:timelimit'] = 'The new time limit for the flipquiz.';
$string['privacy:metadata:flipquiz_overrides:timeopen'] = 'The new open time for the flipquiz.';
$string['privacy:metadata:flipquiz_overrides:userid'] = 'The user being overridden';
$string['privacy:metadata:flipquizaccess'] = 'The flipquiz activity makes use of flipquiz access rules.';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->flipquiznames}<br />The question will not be deleted from these flipquizzes but only from the category list.';
...
$string['questionsinthisflipquiz'] = 'Questions in this flipquiz';
...
$string['flipquiz:addinstance'] = 'Add a new flipquiz';
$string['flipquiz:attempt'] = 'Attempt flipquizzes';
$string['flipquizavailable'] = 'The flipquiz is available until: {$a}';
$string['flipquizclose'] = 'Close the flipquiz';
$string['flipquizclosed'] = 'This flipquiz closed on {$a}';
$string['flipquizcloses'] = 'Quiz closes';
$string['flipquizeventcloses'] = '{$a} closes';
$string['flipquizcloseson'] = 'This flipquiz will close at {$a}';
$string['flipquiz:deleteattempts'] = 'Delete flipquiz attempts';
$string['flipquiz:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['flipquiz:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['flipquiz:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['flipquiz:grade'] = 'Grade flipquizzes manually';
$string['flipquiz:ignoretimelimits'] = 'Ignores time limit on flipquizzes';
$string['flipquizisclosed'] = 'This flipquiz is closed';
$string['flipquizisopen'] = 'This flipquiz is open';
$string['flipquizisclosedwillopen'] = 'Quiz closed (opens {$a})';
$string['flipquizisopenwillclose'] = 'Quiz open (closes {$a})';
$string['flipquiz:manage'] = 'Manage flipquizzes';
$string['flipquiz:manageoverrides'] = 'Manage flipquiz overrides';
$string['flipquiznavigation'] = 'Quiz navigation';
$string['flipquizopen'] = 'Open the flipquiz';
$string['flipquizeventopens'] = '{$a} opens';
$string['flipquizopenclose'] = 'Open and close dates';
$string['flipquizopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['flipquizopenclose_link'] = 'mod/flipquiz/timing';
$string['flipquizopened'] = 'This flipquiz is open.';
$string['flipquizopenedon'] = 'This flipquiz opened at {$a}';
$string['flipquizopens'] = 'Quiz opens';
$string['flipquizopenwillclose'] = 'This flipquiz is open, will close on {$a} at';
$string['flipquizordernotrandom'] = 'Order of flipquiz not shuffled';
$string['flipquizorderrandom'] = '* Order of flipquiz is shuffled';
$string['flipquiz:preview'] = 'Preview flipquizzes';
$string['flipquiz:regrade'] = 'Regrade flipquiz attempts';
$string['flipquiz:reviewmyattempts'] = 'Review your own attempts';
$string['flipquizsettings'] = 'Quiz settings';
$string['flipquiz:view'] = 'View flipquiz information';
$string['flipquiz:viewreports'] = 'View flipquiz reports';
$string['flipquiztimer'] = 'Quiz Timer';
$string['flipquizwillopen'] = 'This flipquiz will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole flipquiz to be graded.  Are you sure you want to continue?';
$string['reattemptflipquiz'] = 'Re-attempt flipquiz';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this flipquiz';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingflipquiz'] = 'Regrading flipquiz "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallflipquizattempts'] = 'Delete all flipquiz attempts';
...
$string['reportusersall'] = 'all users who have attempted the flipquiz';
$string['reportuserswith'] = 'enrolled users who have attempted the flipquiz';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the flipquiz';
$string['reportuserswithout'] = 'enrolled users who have not attempted the flipquiz';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the flipquiz.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Quiz access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) flipquiz, to ensure that only people in a certain location can access the flipquiz.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to flipquiz defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after flipquiz is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while flipquiz is open';
$string['reviewclosed'] = 'After the flipquiz is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->flipquiz} by {$a->user}';
$string['reviewopen'] = 'Later, while the flipquiz is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a flipquiz attempt or look at the flipquiz reports.
...
**Later, while the flipquiz is still open** settings apply after this, and before the flipquiz close date.

**After the flipquiz is closed** settings apply after the flipquiz close date has passed. If the flipquiz does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current flipquiz attempt.';
...
$string['saveflipquiz'] = 'Save this whole flipquiz';
...
$string['showblocks'] = 'Show blocks during flipquiz attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during flipquiz attempts';
...
$string['shufflequestions_help'] = 'If you turn this on, then every time the flipquiz is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the flipquiz, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonflipquiz'] = 'Specified question is not on the specified flipquiz';
...
$string['subneterror'] = 'Sorry, this flipquiz has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this flipquiz.';
$string['subnetnotice'] = 'This flipquiz has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_flipquiz'] = 'Report';
$string['subplugintype_flipquiz_plural'] = 'Reports';
$string['subplugintype_flipquizaccess'] = 'Access rule';
$string['subplugintype_flipquizaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the flipquiz.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the flipquiz since you have not passed the time delay before attempting another flipquiz';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial flipquiz page and a countdown timer is displayed in the flipquiz navigation block.';
$string['timelimit_link'] = 'mod/flipquiz/timing';
...
$string['updatesettings'] = 'Update flipquiz settings';
$string['updateflipquizslotswithrandomxofy'] = 'Updating flipquiz slots with "random" question data ({$a->done}/{$a->total})';
...
$string['upgradesure'] = '<div>In particular the flipquiz module will perform an extensive change of the flipquiz tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingflipquizattempts'] = 'Upgrading flipquiz attempts: flipquiz {$a->done}/{$a->outof} (Quiz id {$a->info})';
$string['upgradingveryoldflipquizattempts'] = 'Upgrading very old flipquiz attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this flipquiz';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} flipquiz attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this flipquiz';
$string['yourfinalgradeis'] = 'Your final grade for this flipquiz is {$a}.';
