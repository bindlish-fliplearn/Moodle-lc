@mod @mod_homework
Feature: Edit homework marks with attempts
  In order to create a homework that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit homework page (even after the homework has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | homework       | Quiz 1 | C1     | homework1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add a "True/False" question to the "Quiz 1" homework with:
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the homework settings say it should be.
