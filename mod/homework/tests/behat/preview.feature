@mod @mod_homework
Feature: Preview a homework as a teacher
  In order to verify my homeworkzes are ready for my students
  As a teacher
  ...
  @javascript
  Scenario: Preview a homework
    When I follow "Quiz 1"
    And I press "Preview homework now"
