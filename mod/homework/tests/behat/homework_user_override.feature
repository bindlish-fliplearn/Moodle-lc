...
Feature: Quiz user override
  In order to grant a student special access to a homework
  As a teacher
  ...
  Scenario: Being able to modify a user override when the homework is not available to the student
