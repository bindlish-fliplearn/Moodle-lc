YUI.add('moodle-mod_homework-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_homework-questionchooser'
});

M.mod_homework = M.mod_homework || {};
M.mod_homework.init_questionchooser = function() {
    M.mod_homework.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_homework.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_homework-util", "querystring-parse"]});
