...
/**
 * Define all the restore steps that will be used by the restore_homework_activity_task
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_homework_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function define_structure() {
        ...
        $paths = array();
        $paths[] = new restore_path_element('homework', '/activity/homework');
