 ...
 *
 * This is also responsible for opening the pop-up window, if the homework requires to be in one.
 *
 * @module    mod_homework/preflightcheck
...
define(['jquery', 'core/yui'], function($, Y) {
    ...
    /**
     * @alias module:mod_homework/preflightcheck
     */
    var t = {
         ...
         * @param {String} popupoptions If not null, the homework should be launced in a pop-up.
         */
            ...
            Y.use('moodle-core-notification', function() {
                if (Y.one(confirmationForm)) {
                    t.confirmDialogue = new M.core.dialogue({
                        ...
                        modal: true,
                        width: null,
                        extraClasses: ['mod_homework_preflight_popup']
                    });
        ...
        /**
         * Event handler for the homework start attempt button.
