 ...
 *
 * @module     mod_homework/modal_homework_question_bank
...
function(
    ...
    var SELECTORS = {
        ADD_TO_QUIZ_CONTAINER: 'td.addtohomeworkaction',
        ANCHOR: 'a[href]',
    ...
    ModalQuizQuestionBank.TYPE = 'mod_homework-homework-question-bank';
     ...
     * when the user clicks the add to homework link.
     *
     ...
     *      - The homework category select box
    ...
    ModalQuizQuestionBank.prototype.registerEventListeners = function() {
        ...
        this.getModal().on('click', SELECTORS.ANCHOR, function(e) {
            ...
            // If the anchor element was the add to homework link.
