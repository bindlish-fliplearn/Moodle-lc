...
/**
 * This page deals with processing responses during an attempt at a homework.
 *
...
if ($attemptobj->is_finished()) {
    throw new moodle_homework_exception($attemptobj->get_homeworkobj(),
...
if ($status == homework_attempt::OVERDUE) {
    redirect($attemptobj->summary_url());
} else if ($status == homework_attempt::IN_PROGRESS) {
    redirect($nexturl);
} else {
