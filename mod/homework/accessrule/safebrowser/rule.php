...
/**
 * Implementaton of the homeworkaccess_safebrowser plugin.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class homeworkaccess_safebrowser extends homework_access_rule_base {

    public static function make(homework $homeworkobj, $timenow, $canignoretimelimits) {

        if ($homeworkobj->get_homework()->browsersecurity !== 'safebrowser') {
            return null;
        }
    ...
    public function prevent_access() {
        if (!$this->check_safe_browser()) {
            return get_string('safebrowsererror', 'homeworkaccess_safebrowser');
        } else {
            return false;
        }
    }
    ...
    public function description() {
        return get_string('safebrowsernotice', 'homeworkaccess_safebrowser');
    }
    ...
    public static function get_browser_security_choices() {
        ...
        return array('safebrowser' =>
                get_string('requiresafeexambrowser', 'homeworkaccess_safebrowser'));
    }
}
