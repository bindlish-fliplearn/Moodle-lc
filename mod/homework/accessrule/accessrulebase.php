...
/**
 * Base class for rules that restrict the ability to attempt a homework.
 *
...
/**
 * A base class that defines the interface for the various homework access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class homework_access_rule_base {
    /** @var stdClass the homework settings. */
    protected $homework;
    /** @var homework the homework object. */
    protected $homeworkobj;
    /** @var int the time to use as 'now'. */
    protected $timenow;

    /**
     * Create an instance of this rule for a particular homework.
     * @param homework $homeworkobj information about the homework in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($homeworkobj, $timenow) {
        $this->homeworkobj = $homeworkobj;
        $this->homework = $homeworkobj->get_homework();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given homework, otherwise return null.
     * @param homework $homeworkobj information about the homework in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/homework:ignoretimelimits capability.
     * @return homework_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_homework_preflight_check_form $homeworkform the form being built.
    ...
    /**
     * This is called when the current attempt at the homework is finished. This is
    ...
    /**
     * Information, such as might be shown on the homework view page, relating to this restriction.
     ...
     * this homework, then return true. This is used so we can know whether to display a
    ...
    /**
     * Add any fields that this rule requires to the homework settings form. This
     * method is called from {@link mod_homework_mod_form::definition()}, while the
    ...
    /**
     * @return array key => lang string any choices to add to the homework Browser
    ...
    /**
     * Save any submitted settings when the homework settings form is submitted. This
     * is called from {@link homework_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the homework is deleted. This is called
     * from {@link homework_delete_instance()} in lib.php.
     ...
     * here is probalby to read the code of {@link homework_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $homeworkid the id of the homework we are loading settings for. This
     *     can also be accessed as homework.id in the SQL. (homework is a table alisas for {homework}.)
     ...
     */
    public static function get_settings_sql($homeworkid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($homeworkid) {
        return array();
    }
}
