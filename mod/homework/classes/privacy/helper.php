...
/**
 * Privacy Subsystem helper for mod_homework.
 *
...
class helper {
    /**
     * Determine the subcontext for the specified homework attempt.
     *
     * @param   \stdClass       $attempt    The attempt data retrieved from the database.
     * @param   \stdClass       $user       The user record.
     * @return  \array                      The calculated subcontext.
     */
    public static function get_homework_attempt_subcontext(\stdClass $attempt, \stdClass $user) {
        $subcontext = [
