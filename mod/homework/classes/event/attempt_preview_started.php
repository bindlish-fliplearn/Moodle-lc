...
/**
 * The mod_homework attempt preview started event.
 *
...
/**
 * The mod_homework attempt preview started event class.
 *
...
class attempt_preview_started extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptpreviewstarted', 'mod_homework');
    }
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' previewed by " .
            "the user with id '$this->userid' for the homework with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/homework/view.php', array('id' => $this->contextinstanceid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'homework', 'preview', 'view.php?id=' . $this->contextinstanceid,
