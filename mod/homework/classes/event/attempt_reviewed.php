...
/**
 * The mod_homework attempt reviewed event.
 *
...
/**
 * The mod_homework attempt reviewed event class.
 *
...
class attempt_reviewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptreviewed', 'mod_homework');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'homework', 'review', 'review.php?attempt=' . $this->objectid,
