...
/**
 * The mod_homework report viewed event.
 *
...
/**
 * The mod_homework report viewed event class.
 *
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'mod_homework');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the report '" . s($this->other['reportname']) . "' for the homework with " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'homework', 'report', 'report.php?id=' . $this->contextinstanceid . '&mode=' .
            $this->other['reportname'], $this->other['homeworkid'], $this->contextinstanceid);
    }
