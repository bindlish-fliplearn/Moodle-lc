...
/**
 * The mod_homework attempt abandoned event.
 *
...
/**
 * The mod_homework attempt abandoned event class.
 *
 * @property-read array $other {
 *      Extra information about event.
 *
 *      - int submitterid: id of submitter (null when trigged by CLI script).
 *      - int homeworkid: (optional) id of the homework.
 * }
 *
 * @package    mod_homework
 * @since      Moodle 2.6
...
class attempt_abandoned extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->relateduserid' has had their attempt with id '$this->objectid' marked as abandoned " .
            "for the homework with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventhomeworkattemptabandoned', 'mod_homework');
    }
    ...
    static public function get_legacy_eventname() {
        return 'homework_attempt_abandoned';
    }
