 ...
 */
function xmldb_homework_overview_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2018061800) {
        ...
        // Define key questionusageid-slot (foreign) to be dropped form homework_overview_regrades.
        $table = new xmldb_table('homework_overview_regrades');
        ...
        upgrade_plugin_savepoint(true, 2018061800, 'homework', 'overview');
    }

    if ($oldversion < 2018061801) {

        // Define key questionusageid-slot (foreign) to be added to homework_overview_regrades.
        $table = new xmldb_table('homework_overview_regrades');
        $key = new xmldb_key('questionusageid-slot', XMLDB_KEY_FOREIGN, array('questionusageid', 'slot'), 'question_attempts', array('questionusageid', 'slot'));
        ...
        // Overview savepoint reached.
        upgrade_plugin_savepoint(true, 2018061801, 'homework', 'overview');
    }
