...
/**
 * This file defines the homework responses table for showing last try at question.
 *
...
/**
 * This is a table subclass for displaying the homework responses report.
 *
 * @copyright 2008 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class homework_last_responses_table extends homework_attempts_report_table {
     ...
     * @param homework_responses_options $options
     * @param \core\dml\sql_join $groupstudentsjoins
     * @param \core\dml\sql_join $studentsjoins
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($homework, $context, $qmsubselect, homework_responses_options $options,
            \core\dml\sql_join $groupstudentsjoins, \core\dml\sql_join $studentsjoins, $questions, $reporturl) {
        parent::__construct('mod-homework-report-responses-report', $homework, $context,
    ...
    public function col_sumgrades($attempt) {
        ...
        $gradehtml = '<a href="review.php?q=' . $this->homework->id . '&amp;attempt=' .
