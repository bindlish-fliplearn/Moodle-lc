...
/**
 * Base class for homework report plugins.
 *
 ...
 * This class displays homework reports.  Because it is called from
 * within /mod/homework/report.php you can assume that the page header
 * and footer are taken care of.
 *
 * This file can refer to itself as report.php to pass variables
 * to itself - all these will also be globally available.  You must
 * pass "id=$cm->id" or q=$homework->id", and "mode=reportname".
 *
 * @copyright 1999 onwards Martin Dougiamas and others {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class homework_default_report {
    const NO_GROUPS_ALLOWED = -2;

    /**
     * Override this function to displays the report.
     * @param $cm the course-module for this homework.
     * @param $course the coures we are in.
     * @param $homework this homework.
     */
    public abstract function display($cm, $course, $homework);
     ...
     */
    public function print_header_and_tabs($cm, $course, $homework, $reportmode = 'overview') {
        global $PAGE, $OUTPUT;

        // Print the page header.
        $PAGE->set_title($homework->name);
