...
/**
 * Unit tests for usage of tags in pratestzes.
 *
 * @package    mod_pratest
...
/**
 * Class mod_pratest_tags_testcase
 * Class for tests related to usage of question tags in pratestzes.
 *
 * @copyright  2018 Shamim Rezaie <shamim@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_pratest_tags_testcase extends advanced_testcase {
    public function test_restore_random_question_by_tag() {
        ...
        get_file_packer('application/vnd.moodle.backup')->extract_to_pathname(
                __DIR__ . "/fixtures/random_by_tag_pratest.mbz", $backuppath);
        ...
        $pratest = array_values($modinfo->get_instances_of('pratest'))[0];
        $pratestobj = pratest::create($pratest->instance);
        ...
        $slottags = pratest_retrieve_slot_tags($question->slotid);
        $this->assertEquals(
                [
