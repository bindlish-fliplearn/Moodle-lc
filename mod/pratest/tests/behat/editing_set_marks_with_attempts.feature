@mod @mod_pratest
Feature: Edit pratest marks with attempts
  In order to create a pratest that awards marks the way I want
  As a teacher
  I must be able to set the marks I want on the Edit pratest page (even after the pratest has been attempted).
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | pratest       | Quiz 1 | C1     | pratest1    | 20    | 2             | -1                    |
    And I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I add a "True/False" question to the "Quiz 1" pratest with:
  ...
  @javascript
  Scenario: Verify the number of decimal places shown is what the pratest settings say it should be.
