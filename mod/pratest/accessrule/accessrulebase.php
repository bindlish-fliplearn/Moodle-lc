...
/**
 * Base class for rules that restrict the ability to attempt a pratest.
 *
 * @package   mod_pratest
...
/**
 * A base class that defines the interface for the various pratest access rules.
 ...
 * @since     Moodle 2.2
 */
abstract class pratest_access_rule_base {
    /** @var stdClass the pratest settings. */
    protected $pratest;
    /** @var pratest the pratest object. */
    protected $pratestobj;
    /** @var int the time to use as 'now'. */
    protected $timenow;

    /**
     * Create an instance of this rule for a particular pratest.
     * @param pratest $pratestobj information about the pratest in question.
     * @param int $timenow the time that should be considered as 'now'.
     */
    public function __construct($pratestobj, $timenow) {
        $this->pratestobj = $pratestobj;
        $this->pratest = $pratestobj->get_pratest();
        $this->timenow = $timenow;
    }

    /**
     * Return an appropriately configured instance of this rule, if it is applicable
     * to the given pratest, otherwise return null.
     * @param pratest $pratestobj information about the pratest in question.
     * @param int $timenow the time that should be considered as 'now'.
     * @param bool $canignoretimelimits whether the current user is exempt from
     *      time limits by the mod/pratest:ignoretimelimits capability.
     * @return pratest_access_rule_base|null the rule, if applicable, else null.
     */
     ...
     *
     * @param mod_pratest_preflight_check_form $pratestform the form being built.
    ...
    /**
     * This is called when the current attempt at the pratest is finished. This is
    ...
    /**
     * Information, such as might be shown on the pratest view page, relating to this restriction.
     ...
     * this pratest, then return true. This is used so we can know whether to display a
    ...
    /**
     * Add any fields that this rule requires to the pratest settings form. This
     * method is called from {@link mod_pratest_mod_form::definition()}, while the
    ...
    /**
     * @return array key => lang string any choices to add to the pratest Browser
    ...
    /**
     * Save any submitted settings when the pratest settings form is submitted. This
     * is called from {@link pratest_after_add_or_update()} in lib.php.
    ...
    /**
     * Delete any rule-specific settings when the pratest is deleted. This is called
     * from {@link pratest_delete_instance()} in lib.php.
     ...
     * here is probalby to read the code of {@link pratest_access_manager::load_settings()}.
     *
     * If you have some settings that cannot be loaded in this way, then you can
     * use the {@link get_extra_settings()} method instead, but that has
     * performance implications.
     *
     * @param int $pratestid the id of the pratest we are loading settings for. This
     *     can also be accessed as pratest.id in the SQL. (pratest is a table alisas for {pratest}.)
     ...
     */
    public static function get_settings_sql($pratestid) {
        return array('', '', array());
    }
     ...
     */
    public static function get_extra_settings($pratestid) {
        return array();
    }
}
