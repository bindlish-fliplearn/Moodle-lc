...
/**
 * The mod_pratest attempt submitted event.
 *
 * @package    mod_pratest
...
/**
 * The mod_pratest attempt submitted event class.
 *
...
class attempt_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpratestattemptsubmitted', 'mod_pratest');
    }
    ...
    static public function get_legacy_eventname() {
        return 'pratest_attempt_submitted';
    }
