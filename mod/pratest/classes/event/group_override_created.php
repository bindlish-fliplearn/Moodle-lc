...
/**
 * The mod_pratest group override created event.
 *
 * @package    mod_pratest
...
/**
 * The mod_pratest group override created event class.
 *
...
class group_override_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverridecreated', 'mod_pratest');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created the override with id '$this->objectid' for the pratest with " .
