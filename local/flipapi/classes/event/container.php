...
namespace local_flipapi\event;

defined('MOODLE_INTERNAL') || die();

use core_calendar\action_factory as action_factory;
use local_flipapi\event\data_access\event_vault as event_vault;
...
use local_flipapi\event\strategies\raw_event_retrieval_strategy as raw_event_retrieval_strategy;
