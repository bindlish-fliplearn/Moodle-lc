...
namespace local_flipapi\event\data_access;
...
use local_flipapi\event\strategies\raw_event_retrieval_strategy_interface;
        ...
        while ($records = array_values($this->retrievalstrategy->get_raw_events(
            ...
            foreach ($records as $record) {
                if ($event = $this->transform_from_database_record($record)) {
                    ...
                    $event->completionstate = $record->completionstate;
                    $event->completionexpected = $record->completionexpected;
                    $event->timemodified = $record->timemodified;
