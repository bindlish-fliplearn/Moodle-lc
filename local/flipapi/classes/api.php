...
namespace local_flipapi;

defined('MOODLE_INTERNAL') || die();

use local_flipapi\event\container;
...
class api {
    ...
    public static function get_events(
        ...
        $vault = \local_flipapi\event\container::get_event_vault();
    ...
    public static function get_action_events_by_timesort(
        ...
        return $data = $vault->get_action_events_by_timesort($USER, $timesortfrom, $timesortto, $afterevent, $limitnum);
    }
