...
$plugin->version   = 2017083120;                // The current plugin version (Date: YYYYMMDDXX).
...
$plugin->component = 'local_primepushnotification'; // Full name of the plugin (used for diagnostics).
