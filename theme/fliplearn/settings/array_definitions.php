...
$marketblockstyles = array(
    '' => get_string('nostyle', 'theme_fliplearn'),
    'internalmarket' => get_string('bcustyle', 'theme_fliplearn'),
    'covtiles' => get_string('coventrystyle', 'theme_fliplearn')
);

$sliderstyles = array(
    'slider1' => get_string('sliderstyle1', 'theme_fliplearn'),
    'slider2' => get_string('sliderstyle2', 'theme_fliplearn')
);

$bootstrap12 = array(
    '0-0-0-0' => get_string('disabled', 'theme_fliplearn'),
    '12-0-0-0' => '1',
    '6-6-0-0' => '6 + 6',
    '4-4-4-0' => '4 + 4 + 4',
    '3-3-3-3' => '3 + 3 + 3 + 3',
