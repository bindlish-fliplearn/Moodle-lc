...
if (!defined('MEDIA_JWPLAYER_CLOUD_VERSION')) {
    ...
    define('MEDIA_JWPLAYER_CLOUD_VERSION', '8.6.0');
}
 ...
 * @return void|false
 */
function media_liveclassplayer_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    ...
    $fullpath = "/$context->id/media_liveclassplayer/$filearea/$relativepath";
