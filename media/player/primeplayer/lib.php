 ...
 * @return void|false
 */
function media_primeplayer_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    ...
    $fullpath = "/$context->id/media_primeplayer/$filearea/$relativepath";
