 ...
 * JW Player module.
 *
 * @module     media_primeplayer/primeplayer
 * @package    media_primeplayer
 * @copyright  2017 Ruslan Kabalin, Lancaster University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
define(['primeplayer', 'jquery', 'core/config', 'core/yui', 'core/log', 'module'], function(primeplayer, $, mdlconfig, Y, log, module) {
    ...
    var logevent = function(event) {
        ...
        Y.io(mdlconfig.wwwroot + '/media/player/primeplayer/eventlogger.php', config);
    };
    ...
    return {
        ...
        setupPlayer: function (playersetup) {
            // Unfortunately other loaded parts of JW player assume that primeplayer
            // lives in window.primeplayer, so we need this hack.
            window.primeplayer = window.primeplayer || primeplayer;
            if (module.config().licensekey) {
                window.primeplayer.key = module.config().licensekey;
            }
            ...
            var playerinstance = primeplayer(playersetup.playerid);
