...
/**
 * Primetype question renderer classes.
 *
 * @package    qtype
...
/**
 * Base class for generating the bits of output common to Primetype
 * single and multiple questions.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_primetype_renderer_base extends qtype_with_combined_feedback_renderer {
     ...
     * options returned by {@link qtype_primetype:;get_numbering_styles()}.
    ...
    protected function correct_choices(array $right) {
        ...
        if (count($right) == 1) {
                return get_string('correctansweris', 'qtype_primetype',
                        implode(', ', $right));
        } else if (count($right) > 1) {
                return get_string('correctanswersare', 'qtype_primetype',
                        implode(', ', $right));
        } else {
                return "";
        }
...
/**
 * Subclass for generating the bits of output specific to Primetype
 * single questions.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_primetype_single_renderer extends qtype_primetype_renderer_base {
    ...
    protected function prompt() {
        return get_string('selectone', 'qtype_primetype');
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_primetype_multi_renderer extends qtype_primetype_renderer_base {
    protected function get_input_type() {
        return 'checkbox';
    }
    ...
    protected function prompt() {
        return get_string('selectmulti', 'qtype_primetype');
    }
    ...
    protected function num_parts_correct(question_attempt $qa) {
        if ($qa->get_question()->get_num_selected_choices($qa->get_last_qt_data()) >
            ...
            return get_string('toomanyselected', 'qtype_primetype');
        }
