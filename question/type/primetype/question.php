...
/**
 * Primetype question definition classes.
 *
 * @package    qtype
...
/**
 * Base class for Primetype questions. The parts that are common to
 * single select and multiple select.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class qtype_primetype_base extends question_graded_automatically {
    ...
    public function apply_attempt_state(question_attempt_step $step) {
        ...
        foreach ($this->order as $ansid) {
            ...
            $a = new stdClass();
            $a->id = 0;
            $a->answer = html_writer::span(get_string('deletedchoice', 'qtype_primetype'),
                    'notifyproblem');
...
/**
 * Represents a Primetype question where only one choice should be selected.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_primetype_single_question extends qtype_primetype_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_primetype', 'single');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectananswer', 'qtype_primetype');
    }
...
/**
 * Represents a Primetype question where Primetype can be selected.
 *
 * @copyright  2009 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_primetype_multi_question extends qtype_primetype_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_primetype', 'multi');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectatleastoneanswer', 'qtype_primetype');
    }
