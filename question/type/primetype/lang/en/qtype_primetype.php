...
/**
 * Strings for component 'qtype_primetype', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['pluginname'] = 'Primetype';
$string['pluginname_help'] = 'In response to a question (that may include a image) the respondent chooses from multiple answers. There are two types of Primetype questions - one answer and multiple answer.';
$string['pluginname_link'] = 'question/type/primetype';
$string['pluginnameadding'] = 'Adding a Primetype question';
$string['pluginnameediting'] = 'Editing a Primetype question';
$string['pluginnamesummary'] = 'Allows the selection of a single or multiple responses from a pre-defined list.';
$string['privacy:metadata'] = 'The Primetype question type plugin does not store any personal data.';
